...
(lib.bg = function() {
	this.initialize(img._396_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1224,1400);


(lib.bg_blur = function() {
	this.initialize(img._396_2_bg_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1224,1400);


(lib.ch_base = function() {
	this.initialize(img._396_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1224,1400);


(lib.ch_face2 = function() {
	this.initialize(img._396_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,196,284);


(lib.ch_face3 = function() {
	this.initialize(img._396_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,196,284);


(lib.ch_face4 = function() {
	this.initialize(img._396_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,196,284);


(lib.ch_face5 = function() {
	this.initialize(img._396_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,196,284);


(lib.ch_face6 = function() {
	this.initialize(img._396_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,196,284);


(lib.finish = function() {
	this.initialize(img._396_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._396_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.first_scene = function() {
	this.initialize(img._396_2_first_scene);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.snow1 = function() {
	this.initialize(img._396_2_snow1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,42,41);


(lib.tie_fp = function() {
	this.initialize(img._396_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._396_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.snow_part = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.snow_part, new cjs.Rectangle(0,0,21,20.5), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,98,142), null);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(31.975,0.425);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(-16,0.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
	this.shape_4.setTransform(-32.025,0.4);
...
(lib.snow1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// snow_part
	this.instance = new lib.snow_part();
	this.instance.parent = this;
	this.instance.setTransform(-0.05,0,1.1801,1.1801,0,0,0,10.4,10.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.snow1_1, new cjs.Rectangle(-12.3,-12,24.8,24.2), null);
...
(lib.mc_pokapoka = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{run:1,run2:27});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(25).call(this.frame_26).wait(1).call(this.frame_27).wait(1));

	// yuge
	this.instance = new lib.obj_yuge();
	this.instance.parent = this;
	this.instance.setTransform(-15.9,11.15,0.599,0.599,-135.1238,0,0,73.9,-160.7);
	this.instance.alpha = 0.6992;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({scaleX:0.7973,scaleY:0.7973,rotation:-135.1241,x:-19,y:14.6,alpha:0},22,cjs.Ease.get(1)).to({_off:true},1).wait(1));

	// yuge
	this.instance_1 = new lib.obj_yuge();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-26.45,13.6,0.3125,0.3125,-135.1187,0,0,89.8,-179.1);
	this.instance_1.alpha = 0.0508;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).wait(1).to({regX:38,regY:-96.3,scaleX:0.3313,scaleY:0.3313,rotation:-135.1186,x:5.1,y:6.3,alpha:0.0564},0).wait(1).to({scaleX:0.3878,scaleY:0.3878,rotation:-135.1184,x:10.4,y:5.05,alpha:0.0734},0).wait(1).to({regX:89.8,regY:-179,scaleX:0.4818,scaleY:0.4818,rotation:-135.118,x:-26.4,y:13.55,alpha:0.1016},0).wait(1).to({regX:38,regY:-96.3,scaleX:0.5228,scaleY:0.5228,rotation:-135.1175,x:23.25,y:2.05,alpha:0.008},0).wait(1).to({regX:89.8,regY:-179,scaleX:0.5263,scaleY:0.5263,x:-26.4,y:13.55,alpha:0},0).to({_off:true},1).wait(21));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-48.3,-87.6,171.7,172);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(62.05,58.95,1.1064,0.6268,0,26.0785,25.8332,0.3,0.2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({_off:false},0).to({_off:true},1).wait(9));

	// mask_face (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_9 = new cjs.Graphics().p("AhkCUIglgeIg5hBIgag9IgIh7QgBgCANgSIAMgRIBFgCIDuBCIBoA2IAWArIh5CfIhmATg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(9).to({graphics:mask_graphics_9,x:24.6713,y:102.825}).wait(1).to({graphics:null,x:0,y:0}).wait(10));

	// face
	this.instance_1 = new lib.ch_face2();
	this.instance_1.parent = this;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off:false},0).to({_off:true},1).wait(10));

	// mask_face (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_8 = new cjs.Graphics().p("AjSB1IgJj5QADAHAXguIB2gHIB5AeIBSAkIBcA4IghCTIhFBPIjUAJg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(8).to({graphics:mask_1_graphics_8,x:23.075,y:106.075}).wait(1).to({graphics:null,x:0,y:0}).wait(11));
	...
	mask_2._off = true;
	var mask_2_graphics_7 = new cjs.Graphics().p("AipCEIgsiFIAAjIQADgCBkAOIBjAOIBzAnIBuBNIgvC3IhSBMIi0ADg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(7).to({graphics:mask_2_graphics_7,x:24.075,y:107.4927}).wait(1).to({graphics:null,x:0,y:0}).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).to({_off:true},1).wait(12));

	// mask_face (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_6 = new cjs.Graphics().p("AhAGNIiuhWIirjRIAKliQgEAAC4iXIC4iXIDlgDIC+BpIAaHoIhOIGIiKAEg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_3_graphics_6,x:53.825,y:61.75}).wait(1).to({graphics:null,x:0,y:0}).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({_off:false},0).to({_off:true},1).wait(13));

	// mask_face (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	mask_4.graphics.p("AnfK8IAA13IO/AAIAAV3g");
	mask_4.setTransform(49,71);

	// face
	this.instance_5 = new lib.ch_face2();
	this.instance_5.parent = this;
	this.instance_5.setTransform(0,0,0.5,0.5);

	this.instance_6 = new lib.ch_face3();
	this.instance_6.parent = this;
	this.instance_6.setTransform(0,0,0.5,0.5);

	this.instance_7 = new lib.ch_face4();
	this.instance_7.parent = this;
	this.instance_7.setTransform(0,0,0.5,0.5);

	this.instance_8 = new lib.ch_face5();
	this.instance_8.parent = this;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).wait(9));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-147,193);
...
p.nominalBounds = new cjs.Rectangle(1,1,96,140);
...
(lib.snowi_anim_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{on:0,off:171});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(167).call(this.frame_167).wait(4).call(this.frame_171).wait(7));

	// leaf2
	this.instance = new lib.snow1_1();
	this.instance.parent = this;
	this.instance.setTransform(-137.7,55.75,0.7778,0.7778);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).wait(1).to({x:-137.6099,y:56.7337},0).wait(1).to({x:-137.2873,y:59.9591},0).wait(1).to({x:-136.6051,y:65.756},0).wait(1).to({x:-135.3914,y:74.1561},0).wait(1).to({x:-133.4422,y:85.0443},0).wait(1).to({x:-130.549,y:98.2309},0).wait(1).to({x:-126.5225,y:113.5015},0).wait(1).to({x:-121.2262,y:130.5866},0).wait(1).to({x:-114.5758,y:149.2232},0).wait(1).to({x:-106.5253,y:169.1946},0).wait(1).to({x:-97.0654,y:190.309},0).wait(1).to({x:-86.2042,y:212.4207},0).wait(1).to({x:-73.9588,y:235.4222},0).wait(1).to({x:-60.4206,y:259.1254},0).wait(1).to({x:-45.1757,y:284.1888},0).wait(1).to({x:-27.3565,y:311.6651},0).wait(1).to({x:-7.6439,y:340.1734},0).wait(1).to({x:13.9216,y:369.4809},0).wait(1).to({x:37.3474,y:399.4616},0).wait(1).to({x:62.63,y:430.0014},0).wait(1).to({x:89.75,y:461},0).wait(1).to({x:121.538,y:495.3015},0).wait(1).to({x:150.8041,y:525.0694},0).wait(1).to({x:179.5731,y:552.6587},0).wait(1).to({x:207.9113,y:578.2386},0).wait(1).to({x:235.6968,y:601.8053},0).wait(1).to({x:262.7966,y:623.3672},0).wait(1).to({x:289.0725,y:642.9512},0).wait(1).to({x:314.0419,y:660.3758},0).wait(1).to({x:333.4337,y:673.0288},0).wait(1).to({x:352.4122,y:684.6049},0).wait(1).to({x:370.2908,y:694.7234},0).wait(1).to({x:387.0585,y:703.4658},0).wait(1).to({x:402.6002,y:710.8743},0).wait(1).to({x:416.8073,y:717.0187},0).wait(1).to({x:429.5349,y:721.9781},0).wait(1).to({x:440.6479,y:725.8595},0).wait(1).to({x:449.9985,y:728.7818},0).wait(1).to({x:457.45,y:730.8742},0).wait(1).to({x:462.8796,y:732.2613},0).wait(1).to({x:466.1866,y:733.0475},0).wait(1).to({x:467.3,y:733.3},0).to({_off:true},1).wait(115));

	// leaf_3
	this.instance_1 = new lib.snow1_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-190.6,246.15,0.7778,0.7778);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(111).to({_off:false},0).wait(1).to({x:-190.5713,y:246.8319},0).wait(1).to({x:-190.4641,y:249.0676},0).wait(1).to({x:-190.222,y:253.0914},0).wait(1).to({x:-189.7602,y:258.9438},0).wait(1).to({x:-188.9684,y:266.5902},0).wait(1).to({x:-187.7231,y:275.9527},0).wait(1).to({x:-185.9039,y:286.9014},0).wait(1).to({x:-183.3985,y:299.3182},0).wait(1).to({x:-180.1146,y:313.0674},0).wait(1).to({x:-175.9845,y:328.0059},0).wait(1).to({x:-170.9699,y:343.9802},0).wait(1).to({x:-165.0405,y:360.8902},0).wait(1).to({x:-158.1878,y:378.628},0).wait(1).to({x:-150.4087,y:397.1164},0).wait(1).to({x:-141.7081,y:416.2896},0).wait(1).to({x:-132.0939,y:436.0961},0).wait(1).to({x:-121.644,y:456.3849},0).wait(1).to({x:-110.0221,y:477.7445},0).wait(1).to({x:-97.0922,y:500.2344},0).wait(1).to({x:-83.006,y:523.4448},0).wait(1).to({x:-67.75,y:547.3},0).wait(1).to({x:-53.891,y:567.9637,alpha:0.907},0).wait(1).to({x:-39.8025,y:588.1272,alpha:0.8186},0).wait(1).to({x:-26.1914,y:606.8887,alpha:0.7347},0).wait(1).to({x:-13.1386,y:624.2864,alpha:0.6553},0).wait(1).to({x:-0.6893,y:640.389,alpha:0.5805},0).wait(1).to({x:11.1191,y:655.2571,alpha:0.5102},0).wait(1).to({x:22.2517,y:668.9388,alpha:0.4444},0).wait(1).to({x:32.6109,y:681.3824,alpha:0.3832},0).wait(1).to({x:42.0462,y:692.4907,alpha:0.3265},0).wait(1).to({x:50.8695,y:702.6857,alpha:0.2744},0).wait(1).to({x:59.0406,y:711.9622,alpha:0.2268},0).wait(1).to({x:66.531,y:720.3277,alpha:0.1837},0).wait(1).to({x:73.3142,y:727.79,alpha:0.1451},0).wait(1).to({x:79.3641,y:734.3552,alpha:0.1111},0).wait(1).to({x:84.6578,y:740.0304,alpha:0.0816},0).wait(1).to({x:89.1747,y:744.8217,alpha:0.0567},0).wait(1).to({x:92.8966,y:748.7346,alpha:0.0363},0).wait(1).to({x:95.8082,y:751.7735,alpha:0.0204},0).wait(1).to({x:97.8973,y:753.9421,alpha:0.0091},0).wait(1).to({x:99.1548,y:755.2426,alpha:0.0023},0).wait(1).to({x:99.55,y:755.7,alpha:0},0).to({_off:true},1).wait(24));

	// leaf2
	this.instance_2 = new lib.snow1_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(124.2,-151.3,0.7778,0.7778);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(55).to({_off:false},0).wait(1).to({x:124.2589,y:-150.6524},0).wait(1).to({x:124.4636,y:-148.5302},0).wait(1).to({x:124.8767,y:-144.7133},0).wait(1).to({x:125.5774,y:-139.1658},0).wait(1).to({x:126.6649,y:-131.9228},0).wait(1).to({x:128.2499,y:-123.0595},0).wait(1).to({x:130.4402,y:-112.6938},0).wait(1).to({x:133.335,y:-100.9488},0).wait(1).to({x:137.0182,y:-87.9491},0).wait(1).to({x:141.5508,y:-73.83},0).wait(1).to({x:146.9686,y:-58.7316},0).wait(1).to({x:153.2937,y:-42.7665},0).wait(1).to({x:160.5377,y:-26.0258},0).wait(1).to({x:168.6988,y:-8.5944},0).wait(1).to({x:177.77,y:9.4607},0).wait(1).to({x:187.7455,y:28.0944},0).wait(1).to({x:198.5998,y:47.2418},0).wait(1).to({x:210.3201,y:66.892},0).wait(1).to({x:223.4353,y:87.7904},0).wait(1).to({x:237.6715,y:109.3544},0).wait(1).to({x:253.05,y:131.5},0).wait(1).to({x:270.087,y:154.8975,alpha:0.907},0).wait(1).to({x:287.5163,y:177.7011,alpha:0.8186},0).wait(1).to({x:304.3707,y:198.8183,alpha:0.7347},0).wait(1).to({x:320.5337,y:218.3058,alpha:0.6553},0).wait(1).to({x:335.9449,y:236.2622,alpha:0.5805},0).wait(1).to({x:350.5561,y:252.7752,alpha:0.5102},0).wait(1).to({x:364.275,y:267.8625,alpha:0.4444},0).wait(1).to({x:376.8338,y:281.3343,alpha:0.3832},0).wait(1).to({x:388.471,y:293.5304,alpha:0.3265},0).wait(1).to({x:399.3627,y:304.6965,alpha:0.2744},0).wait(1).to({x:409.4615,y:314.8364,alpha:0.2268},0).wait(1).to({x:418.7297,y:323.9625,alpha:0.1837},0).wait(1).to({x:427.1319,y:332.088,alpha:0.1451},0).wait(1).to({x:434.6331,y:339.224,alpha:0.1111},0).wait(1).to({x:441.2024,y:345.3821,alpha:0.0816},0).wait(1).to({x:446.8121,y:350.5735,alpha:0.0567},0).wait(1).to({x:451.4375,y:354.8075,alpha:0.0363},0).wait(1).to({x:455.058,y:358.0925,alpha:0.0204},0).wait(1).to({x:457.6568,y:360.4347,alpha:0.0091},0).wait(1).to({x:459.2216,y:361.8386,alpha:0.0023},0).wait(1).to({x:459.75,y:362.3,alpha:0},0).to({_off:true},1).wait(80));

	// snow
	this.instance_3 = new lib.snow1_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(33.7,-240.65,0.7778,0.7778);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({x:33.9002,y:-239.9233},0).wait(1).to({x:34.5722,y:-237.544},0).wait(1).to({x:35.8398,y:-233.2755},0).wait(1).to({x:37.8123,y:-227.1004},0).wait(1).to({x:40.6076,y:-219.0921},0).wait(1).to({x:44.3427,y:-209.3857},0).wait(1).to({x:49.12,y:-198.1537},0).wait(1).to({x:55.0306,y:-185.5609},0).wait(1).to({x:62.1317,y:-171.7899},0).wait(1).to({x:70.4438,y:-157.0303},0).wait(1).to({x:79.9754,y:-141.4297},0).wait(1).to({x:90.7179,y:-125.1158},0).wait(1).to({x:102.6527,y:-108.1926},0).wait(1).to({x:115.7576,y:-90.7403},0).wait(1).to({x:130.0101,y:-72.8197},0).wait(1).to({x:145.3229,y:-54.5553},0).wait(1).to({x:161.9221,y:-35.7106},0).wait(1).to({x:180.1793,y:-15.9741},0).wait(1).to({x:199.85,y:4.25},0).wait(1).to({x:221.5569,y:25.5161},0).wait(1).to({x:243.6941,y:46.1499},0).wait(1).to({x:264.9619,y:65.0964},0).wait(1).to({x:285.2326,y:82.4359},0).wait(1).to({x:304.4566,y:98.2906},0).wait(1).to({x:322.5963,y:112.768},0).wait(1).to({x:339.5907,y:125.9353},0).wait(1).to({x:355.2103,y:137.7125},0).wait(1).to({x:369.4291,y:148.1651},0).wait(1).to({x:382.7071,y:157.6943},0).wait(1).to({x:394.9858,y:166.3061},0).wait(1).to({x:406.2275,y:174.0212},0).wait(1).to({x:416.3965,y:180.8602},0).wait(1).to({x:425.4574,y:186.8415},0).wait(1).to({x:433.3791,y:191.9838},0).wait(1).to({x:440.1335,y:196.3042},0).wait(1).to({x:445.6961,y:199.8176},0).wait(1).to({x:450.0458,y:202.5368},0).wait(1).to({x:453.1658,y:204.4722},0).wait(1).to({x:455.0435,y:205.6308},0).wait(1).to({x:455.65,y:206.05},0).to({_off:true},1).wait(137));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-200.1,-250,677.1,1015.1);


(lib.snowi_anim = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"on":0,"off":176});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(172).call(this.frame_172).wait(4).call(this.frame_176).wait(7));

	// leaf2
	this.instance = new lib.snow1_1();
	this.instance.parent = this;
	this.instance.setTransform(65.95,-201.55);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(35).to({_off:false},0).to({guide:{path:[66,-201.4,75.6,-94.5,160.7,52.1,192.5,107.1,231.6,162.1]}},21,cjs.Ease.get(-1)).to({guide:{path:[231.7,162.2,290,244.2,364.5,326.3,430.2,398.8,497.3,458.8]}},21,cjs.Ease.get(1)).to({_off:true},1).wait(105));

	// leaf_3
	this.instance_1 = new lib.snow1_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-2.05,43.25);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(126).to({_off:false},0).to({guide:{path:[-1.9,43.4,2.4,150.6,80.2,301.2,113.4,365.7,155.9,430.5]}},21,cjs.Ease.get(-1)).to({guide:{path:[156,430.5,206.5,507.5,270.2,585.1,320,645.8,371,698.4]}},21,cjs.Ease.get(1)).to({_off:true},1).wait(14));

	// leaf2
	this.instance_2 = new lib.snow1_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-203.55,-32);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(70).to({_off:false},0).to({guide:{path:[-203.4,-31.9,-193.8,75,-108.7,221.6,-76.9,276.6,-37.8,331.6]}},21,cjs.Ease.get(-1)).to({guide:{path:[-37.7,331.7,20.7,413.8,95.1,495.8,189.7,600.2,286.9,678.6]}},21,cjs.Ease.get(1)).to({_off:true},1).wait(70));

	// snow
	this.instance_3 = new lib.snow1_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-232.45,104.55);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({_off:false},0).to({guide:{path:[-232.4,104.7,-204,208.2,-94.4,337.4,-59.2,378.9,-18.9,419.4]}},19,cjs.Ease.get(-1)).to({guide:{path:[-18.7,419.4,58.6,497,154.8,571.1,233,631.3,310.1,678.8]}},21,cjs.Ease.get(1)).to({_off:true},1).wait(127));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-244.7,-213.6,754.5999999999999,924.1);
...
(lib.glitters = function(mode,startPosition,loop) {
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(27.65,92.9,0.0849,0.0849);
	this.instance_4._off = true;
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(140.85,254.75,0.1618,0.1618);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(220.55,57,0.1362,0.1362);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(143.6,34.05,0.2555,0.2555);
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(197.2,242.05,0.1176,0.1176);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(28.5,25.45,0.1138,0.1138);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 1, 1, 0, 0, 0, 0, 1, 0, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AA8EbIi9hYIhQg3IgZhSIARiTIAZhpQB2haAAACIBGAFIBXBBIBBBdIBQCrIAHCNIgeA3IhXAjg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:74.625,y:55.1216}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:49,regY:71,x:49,y:71,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:49,regY:71,x:49,y:71,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:49,regY:71,x:49,y:71,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:49,regY:71,x:49,y:71,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-267,-203,612,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-182,-138);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-302,-534,612.2,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(55).call(this.frame_496).wait(21).call(this.frame_517).wait(21).call(this.frame_538).wait(73).call(this.frame_611).wait(1).call(this.frame_612).wait(20).call(this.frame_632).wait(1));

	// breath
	this.breath = new lib.mc_pokapoka();
	this.breath.name = "breath";
	this.breath.parent = this;
	this.breath.setTransform(-13.45,-233.6,0.8833,1.5698,0,-61.4386,108.0187);

	this.timeline.addTween(cjs.Tween.get(this.breath).wait(633));

	// effect2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-58.75,-308.85,1.1645,1.1645);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-84.35,y:-317.85,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-96,y:-322.15,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-58.75,y:-308.85,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-84.35,y:-317.85,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-96,y:-322.15,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-58.75,y:-308.85,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-84.35,y:-317.85,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-96,y:-322.15,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-58.75,y:-308.85,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-84.35,y:-317.85,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-96,y:-322.15,alpha:0.2188},0).to({_off:true},1).wait(301));

	// effect
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-3,-298,1.4808,1.4808);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-3,-298,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-120.3,-359.75,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-125.8,-357.75,1.4204,1.4204,35.8424,0,0,-30.3,20.6);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-91.4,-316.1,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-70.05,-345.7,1.053,1.053,-28.4906);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-74.5,-367,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-66.8,-352.8,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-60.55,-299.1,0.9876,0.9876,14.9998);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-70.15,-357.75,1.3878,1.3878,-121.2396);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-36.65,-203.35);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-69.45,-312.95,0.4532,0.4532);
	this.instance_12._off = true;

	this.instance_13 = new lib.angry("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(64.1,-322.05,0.5276,0.5276);
	this.instance_13._off = true;

	this.instance_14 = new lib.mc_punpun();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-51.55,-382.2,1.1377,1.1377);

	this.instance_15 = new lib.concent_wrapper("synched",0,false);
	this.instance_15.parent = this;
	this.instance_15.setTransform(-4.85,-292.25,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_2}]},10).to({state:[]},10).to({state:[{t:this.instance_3}]},76).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},7).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},16).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},24).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},11).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},2).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},6).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},5).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},2).to({state:[]},12).to({state:[{t:this.instance_15}]},17).to({state:[]},9).to({state:[{t:this.instance_5}]},55).to({state:[]},20).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_4}]},74).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-119.9,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-120.3,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-119.9,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-120.3,alpha:0},0).to({_off:true},1).wait(474));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-128.3,y:-356.9,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-125.8,y:-357.75,alpha:0,startPosition:19},0).to({_off:true},1).wait(432).to({_off:false,regX:-30.4,scaleX:1.079,scaleY:1.079,rotation:27.8392,x:-125.95,y:-332.1,alpha:1,startPosition:0},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,x:-127.6,y:-331.15,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.4,regY:20.6,x:-125.95,y:-332.1,alpha:0,startPosition:19},0).to({_off:true},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-77,y:-359.1,alpha:0.5556},0).wait(1).to({x:-81.1,y:-367.35,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-82.4,y:-370.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-82.15,y:-369.45},0).wait(1).to({x:-81.15,y:-367.6},0).wait(1).to({x:-79.45,y:-364.45},0).wait(1).to({regX:0,regY:0,x:-77,y:-360.4},0).to({x:-77.75,y:-361.75},2).wait(8).to({regX:-0.2,regY:0.2,x:-77.5,y:-360.85,alpha:0.9298},0).wait(1).to({x:-76.45,y:-358.9,alpha:0.692},0).wait(1).to({x:-74.85,y:-356,alpha:0.339},0).wait(1).to({x:-73.7,y:-353.85,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-73.25,y:-353.55,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-70.5,y:-345.3},0).wait(1).to({regX:-0.2,regY:0.2,x:-77.45,y:-358.7,alpha:0.5556},0).wait(1).to({x:-81.55,y:-366.95,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-82.85,y:-370,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-82.6,y:-369.05},0).wait(1).to({x:-81.6,y:-367.2},0).wait(1).to({x:-79.9,y:-364.05},0).wait(1).to({regX:0,regY:0,x:-77.45,y:-360},0).to({x:-78.2,y:-361.35},2).wait(3).to({regX:-0.2,regY:0.2,x:-77.95,y:-360.45,alpha:0.9298},0).wait(1).to({x:-76.9,y:-358.5,alpha:0.692},0).wait(1).to({x:-75.3,y:-355.6,alpha:0.339},0).wait(1).to({x:-74.15,y:-353.45,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-73.7,y:-353.15,alpha:0},0).to({_off:true},1).wait(386));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-65.8,y:-349.1},0).wait(1).to({y:-345.25},0).wait(1).to({y:-342},0).wait(1).to({y:-339.35},0).wait(1).to({y:-337.25},0).wait(1).to({y:-335.75},0).wait(1).to({y:-334.85},0).wait(1).to({regX:-0.5,regY:0.2,x:-66.8,y:-333.8},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-65.8,y:-334.6,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-66.8,y:-333.8,alpha:0},0).to({_off:true},1).wait(344));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-91.975,y:-294.4875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-102.45,y:-292.95,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-60.55,y:-299.1,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-91.975,y:-298.875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-102.45,y:-298.8,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-60.55,y:-299.1,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-91.975,y:-294.4875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-102.45,y:-292.95,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-60.55,y:-299.1,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-91.975,y:-298.875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-102.45,y:-298.8,alpha:0.2188},0).to({_off:true},1).wait(301));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:-37.65,y:-202.35,alpha:1},0).wait(1).to({regX:0.9,x:-37.75,y:-201.4,alpha:0.8965},0).wait(1).to({x:-39.1,y:-200.2,alpha:0.7636},0).wait(1).to({x:-40.7,y:-198.75,alpha:0.6048},0).wait(1).to({x:-42.5,y:-197.15,alpha:0.4229},0).wait(1).to({x:-44.5,y:-195.3,alpha:0.2205},0).wait(1).to({regX:0,x:-47.65,y:-193.35,alpha:0},0).to({_off:true},1).wait(274));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-71.2,y:-327.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-74.45,y:-332.95},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-71.9,y:-330.8},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-71.35,y:-327.55},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-72.45,y:-322.95},0).to({scaleX:1,scaleY:1,x:-73.45,y:-326.95},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-70.85,y:-325.95,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-72.45,y:-326.7,alpha:0.1016},0).to({_off:true},1).wait(250));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-325.8},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-327.05},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(231));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:4,regY:-184,x:4,y:-192.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:4,regY:-184,x:4,y:-193.2},0).wait(1).to({y:-190.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:4,regY:-184,x:4,y:-189.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:4,regY:-184,x:4,y:-189.75},0).wait(1).to({y:-182.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:4,regY:-184,x:4,y:-180.75},0).wait(1).to({y:-183.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:4,regY:-184,x:4,y:-188.95},0).wait(1).to({y:-183.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:4,regY:-184,x:4,y:-188.95},0).wait(1).to({y:-183.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:4,regY:-184,x:4,y:-183.1},0).wait(1).to({y:-183.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:4,regY:-184,x:4,y:-193},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:4,regY:-184,x:4,y:-196.95},0).wait(1).to({y:-193.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:4,regY:-184,x:4,y:-182},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:4,regY:-184,x:4,y:-184.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:4,regY:-184,x:4,y:-193},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:4,regY:-184,x:4,y:-196.95},0).wait(1).to({y:-193.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:4,regY:-184,x:4,y:-182},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:4,regY:-184,x:4,y:-184.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:4,regY:-184,x:4,y:-183.4},0).wait(1).to({y:-181},0).wait(1).to({y:-178.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:4,regY:-184,x:4,y:-178.65},0).wait(1).to({y:-181},0).wait(1).to({y:-183.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:4,regY:-184,x:4,y:-183.85},0).wait(1).to({y:-183.3},0).wait(1).to({y:-182.2},0).wait(1).to({y:-180.85},0).wait(1).to({y:-179.75},0).wait(1).to({y:-179.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:4,regY:-184,x:4,y:-179.2},0).wait(1).to({y:-179.75},0).wait(1).to({y:-180.85},0).wait(1).to({y:-182.2},0).wait(1).to({y:-183.3},0).wait(1).to({y:-183.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:4,regY:-184,x:4,y:-179.25},0).wait(1).to({y:-182.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:4,regY:-184,x:4,y:-181.8},0).wait(1).to({y:-183.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:4,regY:-184,rotation:0.0244,x:4.1,y:-183.95},0).wait(1).to({rotation:0.1092,x:4.45,y:-183.65},0).wait(1).to({rotation:0.275,x:5.25,y:-183.1},0).wait(1).to({rotation:0.538,x:6.45,y:-182.2},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:7.95,y:-181.05},0).wait(1).to({rotation:1.1673,x:9.3,y:-180},0).wait(1).to({rotation:1.367,x:10.2,y:-179.3},0).wait(1).to({rotation:1.4695,x:10.65,y:-178.9},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:4,regY:-184,rotation:1.479,x:10.65,y:-178.95},0).wait(1).to({rotation:1.4111,x:10.35,y:-179.15},0).wait(1).to({rotation:1.2801,x:9.75,y:-179.65},0).wait(1).to({rotation:1.0711,x:8.8,y:-180.4},0).wait(1).to({rotation:0.7884,x:7.55,y:-181.3},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4865,x:6.15,y:-182.35},0).wait(1).to({rotation:0.2415,x:5,y:-183.2},0).wait(1).to({rotation:0.0832,x:4.3,y:-183.75},0).wait(1).to({rotation:0.0011,x:4,y:-184},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:4,regY:-184,rotation:0.0244,x:4.1,y:-183.95},0).wait(1).to({rotation:0.1092,x:4.45,y:-183.65},0).wait(1).to({rotation:0.275,x:5.25,y:-183.1},0).wait(1).to({rotation:0.538,x:6.45,y:-182.2},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:7.95,y:-181.05},0).wait(1).to({rotation:1.1673,x:9.3,y:-180},0).wait(1).to({rotation:1.367,x:10.2,y:-179.3},0).wait(1).to({rotation:1.4695,x:10.65,y:-178.9},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:4,regY:-184,rotation:1.4793,x:10.65,y:-178.95},0).wait(1).to({rotation:1.4124,x:10.35,y:-179.15},0).wait(1).to({rotation:1.2834,x:9.75,y:-179.65},0).wait(1).to({rotation:1.0775,x:8.8,y:-180.35},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:7.55,y:-181.3},0).wait(1).to({rotation:0.5016,x:6.2,y:-182.35},0).wait(1).to({rotation:0.2603,x:5.1,y:-183.2},0).wait(1).to({rotation:0.1043,x:4.4,y:-183.75},0).wait(1).to({rotation:0.0235,x:4.05,y:-184},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:4,regY:-184,x:4,y:-189.55},0).wait(1).to({y:-191.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:4,regY:-184,x:4,y:-191.35},0).wait(1).to({y:-189.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:4,regY:-184,x:4,y:-192.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:4,regY:-184,x:4,y:-193.2},0).wait(1).to({y:-190.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:4,regY:-184,rotation:0.0244,x:4.1,y:-183.95},0).wait(1).to({rotation:0.1092,x:4.45,y:-183.65},0).wait(1).to({rotation:0.275,x:5.25,y:-183.1},0).wait(1).to({rotation:0.538,x:6.45,y:-182.2},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:7.95,y:-181.05},0).wait(1).to({rotation:1.1673,x:9.3,y:-180},0).wait(1).to({rotation:1.367,x:10.2,y:-179.3},0).wait(1).to({rotation:1.4695,x:10.65,y:-178.9},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:4,regY:-184,rotation:1.4793,x:10.65,y:-178.95},0).wait(1).to({rotation:1.4124,x:10.35,y:-179.15},0).wait(1).to({rotation:1.2834,x:9.75,y:-179.65},0).wait(1).to({rotation:1.0775,x:8.8,y:-180.35},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:7.55,y:-181.3},0).wait(1).to({rotation:0.5016,x:6.2,y:-182.35},0).wait(1).to({rotation:0.2603,x:5.1,y:-183.2},0).wait(1).to({rotation:0.1043,x:4.4,y:-183.75},0).wait(1).to({rotation:0.0235,x:4.05,y:-184},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(2).to({regX:4,regY:-184,rotation:0.1421,x:4.6,y:-183.55},0).wait(1).to({rotation:0.6998,x:7.15,y:-181.6},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:10,y:-179.45},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:4,regY:-184,rotation:1.4399,x:10.45,y:-179.05},0).wait(1).to({rotation:1.2196,x:9.45,y:-179.85},0).wait(1).to({rotation:0.7884,x:7.55,y:-181.3},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:5.35,y:-182.95},0).wait(1).to({rotation:0.0482,x:4.15,y:-183.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:4,regY:-184,rotation:0.0865,x:4.4,y:-183.75},0).wait(1).to({rotation:0.4213,x:5.9,y:-182.55},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:8.5,y:-180.6},0).wait(1).to({rotation:1.3945,x:10.35,y:-179.2},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:4,regY:-184,rotation:1.4399,x:10.45,y:-179.05},0).wait(1).to({rotation:1.2196,x:9.45,y:-179.85},0).wait(1).to({rotation:0.7884,x:7.55,y:-181.3},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:5.35,y:-182.95},0).wait(1).to({rotation:0.0482,x:4.15,y:-183.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:4,regY:-184,x:4,y:-192.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:4,regY:-184,x:4,y:-193.2},0).wait(1).to({y:-190.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:4,regY:-184,x:1.25,y:-176.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:4,regY:-184,x:4,y:-171.75},0).wait(1).to({y:-174.7},0).wait(1).to({y:-179.65},0).wait(1).to({y:-183.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:4,regY:-184,x:4,y:-183},0).wait(1).to({y:-177.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:4,regY:-184,x:4,y:-176.2},0).wait(1).to({y:-180.5},0).wait(1).to({y:-184.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:4,regY:-184,x:4,y:-184.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:4,regY:-184,x:4,y:-190.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:4,regY:-184,x:4,y:-190.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:4,regY:-184,x:4,y:-192.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:4,regY:-184,x:4,y:-193.2},0).wait(1).to({y:-190.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:4,regY:-184,x:1.25,y:-176.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:4,regY:-184,x:4,y:-173.25},0).wait(1).to({y:-181},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:4,regY:-184,x:4,y:-185},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:4,regY:-184,x:4,y:-184.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:4,regY:-184,x:4,y:-183.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:4,regY:-184,x:4,y:-183.4},0).wait(1).to({y:-181},0).wait(1).to({y:-178.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:4,regY:-184,x:4,y:-178.6},0).wait(1).to({y:-178.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:4,regY:-184,x:4,y:-179.4},0).wait(1).to({y:-180.9},0).wait(1).to({y:-183.15},0).wait(1).to({y:-184.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:4,regY:-184,x:4,y:-184.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:4,regY:-184,x:4,y:-191.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:4,regY:-184,x:4,y:-193.2},0).wait(1).to({y:-190.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:4,regY:-184,x:4,y:-191.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:4,regY:-184,x:4,y:-192},0).wait(1).to({y:-186},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:4,regY:-184,x:4,y:-179.35},0).wait(1).to({y:-180.55},0).wait(1).to({y:-182.5},0).wait(1).to({y:-183.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:4,regY:-184,x:4,y:-188.95},0).wait(1).to({y:-183.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:4,regY:-184,x:4,y:-188.95},0).wait(1).to({y:-183.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:4,regY:-184,x:4,y:-183.1},0).wait(1).to({y:-183.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:4,regY:-184,x:7,y:-180.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:4,regY:-184,x:3.15,y:-174.55},0).wait(1).to({x:3.8,y:-174.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:4,regY:-184,x:4,y:-174.7},0).wait(1).to({y:-177.15},0).wait(1).to({y:-180.85},0).wait(1).to({y:-183.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(10).to({regX:-0.1,rotation:-0.0009,x:-5.5,y:12.2},7,cjs.Ease.quadInOut).to({regX:0,rotation:0,x:-11,y:0},7,cjs.Ease.quadInOut).to({regX:-0.1,regY:0.1,rotation:0.0009,x:-7.15,y:12.2},6,cjs.Ease.quadInOut).to({regX:0,regY:0,rotation:0,x:0,y:0},7,cjs.Ease.quadInOut).to({rotation:-0.0009,x:-5.45,y:12.15},7,cjs.Ease.quadInOut).to({rotation:0,x:-11,y:0},7,cjs.Ease.quadInOut).to({regX:-0.1,regY:0.1,rotation:0.0009,x:-7.15,y:12.2},6,cjs.Ease.quadInOut).to({regX:0,regY:0,rotation:0,x:0,y:0},7,cjs.Ease.quadInOut).wait(2).to({regX:4,regY:-184,x:4,y:-183.85},0).wait(1).to({y:-183.3},0).wait(1).to({y:-182.2},0).wait(1).to({y:-180.85},0).wait(1).to({y:-179.75},0).wait(1).to({y:-179.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:4,regY:-184,x:4,y:-179.2},0).wait(1).to({y:-179.75},0).wait(1).to({y:-180.85},0).wait(1).to({y:-182.2},0).wait(1).to({y:-183.3},0).wait(1).to({y:-183.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(7).to({y:6},0).wait(1).to({regX:4,regY:-184,x:4,y:-193},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:4,regY:-184,x:4,y:-196.95},0).wait(1).to({y:-193.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:4,regY:-184,x:4,y:-182},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:4,regY:-184,x:4,y:-184.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({x:-5.5,y:5},12,cjs.Ease.quadInOut).to({x:-11,y:0},12,cjs.Ease.quadInOut).to({x:-7.15,y:5},12,cjs.Ease.quadInOut).to({x:0,y:0},13,cjs.Ease.quadInOut).wait(26).to({regX:4,regY:-184,x:4,y:-183.85},0).wait(1).to({y:-183.3},0).wait(1).to({y:-182.2},0).wait(1).to({y:-180.85},0).wait(1).to({y:-179.75},0).wait(1).to({y:-179.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:4,regY:-184,x:4,y:-179.2},0).wait(1).to({y:-179.75},0).wait(1).to({y:-180.85},0).wait(1).to({y:-182.2},0).wait(1).to({y:-183.3},0).wait(1).to({y:-183.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(7));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-692.5,859.7,875.7);
...
// stage content:
(lib._396_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:287,scene2:288,end2:560,scene3:561,end3:736,scene4:737,end4:1006,scene5:1007,end5:1241,scene6:1242,end6:1494,scene7:1495,end7:1806});
	...
	this.frame_532 = function() {
		exportRoot._g.m4 = "ろんﾌﾟﾛﾃﾞｭｰｻｰさん､";
		exportRoot._u.setText();
	...
	this.frame_770 = function() {
		exportRoot._g.m1 = "ﾌﾟﾛﾃﾞｭｰｻｰさん､いいの……? ";
		exportRoot._u.setText();
	...
	this.frame_1306 = function() {
		exportRoot._g.m2 = "ﾄﾞｷﾄﾞｷする……♪";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 5);
		
		this.ch2.gotoAndPlay("jump_chord");
	}
	this.frame_1349 = function() {
		exportRoot._g.m2 = "ﾄﾞｷﾄﾞｷする……♪あのね､";
		exportRoot._u.setText();
	...
	this.frame_1384 = function() {
		exportRoot._g.m3 = "は､楽しいよ……";
		exportRoot._u.setText();
	...
	this.frame_1422 = function() {
		exportRoot._g.m3 = "は､楽しいよ……だから､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 3);
		
		//this.ch2.gotoAndPlay("walk2");
	}
	this.frame_1443 = function() {
		exportRoot._g.m3 = this.m.t[exportRoot._g.idx][3];
		exportRoot._g.m4 = "ｰｻｰさんも､";
		exportRoot._u.setText();
		
		//exportRoot._u.setFace("ch2", 1);
		
		//this.ch2.breath.gotoAndPlay("run");
	}
	...
	this.frame_1528 = function() {
		exportRoot._g.m1 = "えへへ､捕まえたら……";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 2);
	}
	this.frame_1556 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._u.setText();
	...
	this.frame_1584 = function() {
		exportRoot._g.m2 = "離さないよ……｡";
		exportRoot._u.setText();
	}
	this.frame_1625 = function() {
		exportRoot._g.m2 = "離さないよ……｡ふたりで､";
		exportRoot._u.setText();
	...
	this.frame_1638 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "になって……";
		exportRoot._u.setText();
	...
	this.frame_1683 = function() {
		exportRoot._g.m3 = "になって……ずーっと､";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(17).call(this.frame_32).wait(37).call(this.frame_69).wait(30).call(this.frame_99).wait(19).call(this.frame_118).wait(43).call(this.frame_161).wait(27).call(this.frame_188).wait(45).call(this.frame_233).wait(29).call(this.frame_262).wait(25).call(this.frame_287).wait(1).call(this.frame_288).wait(44).call(this.frame_332).wait(20).call(this.frame_352).wait(60).call(this.frame_412).wait(29).call(this.frame_441).wait(62).call(this.frame_503).wait(29).call(this.frame_532).wait(21).call(this.frame_553).wait(7).call(this.frame_560).wait(1).call(this.frame_561).wait(37).call(this.frame_598).wait(64).call(this.frame_662).wait(35).call(this.frame_697).wait(39).call(this.frame_736).wait(1).call(this.frame_737).wait(33).call(this.frame_770).wait(34).call(this.frame_804).wait(54).call(this.frame_858).wait(25).call(this.frame_883).wait(54).call(this.frame_937).wait(30).call(this.frame_967).wait(18).call(this.frame_985).wait(21).call(this.frame_1006).wait(1).call(this.frame_1007).wait(39).call(this.frame_1046).wait(19).call(this.frame_1065).wait(28).call(this.frame_1093).wait(21).call(this.frame_1114).wait(15).call(this.frame_1129).wait(52).call(this.frame_1181).wait(27).call(this.frame_1208).wait(18).call(this.frame_1226).wait(15).call(this.frame_1241).wait(1).call(this.frame_1242).wait(32).call(this.frame_1274).wait(32).call(this.frame_1306).wait(43).call(this.frame_1349).wait(21).call(this.frame_1370).wait(14).call(this.frame_1384).wait(38).call(this.frame_1422).wait(21).call(this.frame_1443).wait(33).call(this.frame_1476).wait(18).call(this.frame_1494).wait(1).call(this.frame_1495).wait(33).call(this.frame_1528).wait(28).call(this.frame_1556).wait(28).call(this.frame_1584).wait(41).call(this.frame_1625).wait(13).call(this.frame_1638).wait(45).call(this.frame_1683).wait(43).call(this.frame_1726).wait(35).call(this.frame_1761).wait(31).call(this.frame_1792).wait(14).call(this.frame_1806).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1811));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1806).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1811));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1792));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1796));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1805));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1721).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1761).to({_off:false},0).wait(1).to({regX:3.5,regY:59.1,x:123.5,y:380.6},0).wait(1).to({y:378.9},0).wait(1).to({y:375.6},0).wait(1).to({y:370.25},0).wait(1).to({y:362.8},0).wait(1).to({y:354.45},0).wait(1).to({y:347.5},0).wait(1).to({y:342.95},0).wait(1).to({y:340.65},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1761).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1761).to({_off:false},0).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1761).to({_off:false},0).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1749).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(1476).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(308));

	// snow
	this.snow = new lib.snowi_anim();
	this.snow.name = "snow";
	this.snow.parent = this;
	this.snow.setTransform(59.15,-47.85,0.5479,0.5479,0.1532);

	this.timeline.addTween(cjs.Tween.get(this.snow).to({_off:true},15).wait(1796));

	// snow2
	this.snow2 = new lib.snowi_anim_2();
	this.snow2.name = "snow2";
	this.snow2.parent = this;
	this.snow2.setTransform(-62.25,-42.75,0.4824,0.5064,0.1468,0,0,-219.1,15.2);

	this.timeline.addTween(cjs.Tween.get(this.snow2).to({_off:true},15).wait(1796));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1796));

	// first_scene
	this.instance_13 = new lib.first_scene_1();
	this.instance_13.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:true},15).wait(1796));

	// overlay_top
	this.instance_14 = new lib.overlay_black();
	this.instance_14.parent = this;
	this.instance_14.setTransform(120,-2);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:-3.2},0).wait(1).to({y:-6.85},0).wait(1).to({y:-12.75},0).wait(1).to({y:-20.7},0).wait(1).to({y:-30.4},0).wait(1).to({y:-41.5},0).wait(1).to({y:-53.55},0).wait(1).to({y:-65.9},0).wait(1).to({y:-78.05},0).wait(1).to({y:-89.25},0).wait(1).to({y:-98.95},0).wait(1).to({y:-106.45},0).wait(1).to({y:-111.3},0).wait(1).to({regX:0,x:120,y:-113},0).wait(71).to({regX:1,x:121,y:-113.55},0).wait(1).to({y:-115.3},0).wait(1).to({y:-118.05},0).wait(1).to({y:-121.85},0).wait(1).to({y:-126.45},0).wait(1).to({y:-131.85},0).wait(1).to({y:-137.85},0).wait(1).to({y:-144.35},0).wait(1).to({y:-151.2},0).wait(1).to({y:-158.2},0).wait(1).to({y:-165.15},0).wait(1).to({y:-171.95},0).wait(1).to({y:-178.4},0).wait(1).to({y:-184.25},0).wait(1).to({y:-189.4},0).wait(1).to({y:-193.7},0).wait(1).to({y:-196.9},0).wait(1).to({y:-198.9},0).wait(1).to({regX:0,x:120,y:-199.65},0).to({_off:true},1).wait(1692));

	// overlay_bottom
	this.instance_15 = new lib.overlay_black();
	this.instance_15.parent = this;
	this.instance_15.setTransform(120,308);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:308.45},0).wait(1).to({y:309.8},0).wait(1).to({y:312.05},0).wait(1).to({y:315.05},0).wait(1).to({y:318.75},0).wait(1).to({y:322.95},0).wait(1).to({y:327.5},0).wait(1).to({y:332.15},0).wait(1).to({y:336.75},0).wait(1).to({y:341},0).wait(1).to({y:344.65},0).wait(1).to({y:347.5},0).wait(1).to({y:349.35},0).wait(1).to({regX:0,x:120,y:350},0).wait(71).to({regX:1,x:121,y:351.05},0).wait(1).to({y:354.2},0).wait(1).to({y:359.25},0).wait(1).to({y:366.1},0).wait(1).to({y:374.55},0).wait(1).to({y:384.4},0).wait(1).to({y:395.35},0).wait(1).to({y:407.2},0).wait(1).to({y:419.65},0).wait(1).to({y:432.4},0).wait(1).to({y:445.15},0).wait(1).to({y:457.5},0).wait(1).to({y:469.25},0).wait(1).to({y:479.95},0).wait(1).to({y:489.35},0).wait(1).to({y:497.15},0).wait(1).to({y:503},0).wait(1).to({y:506.7},0).wait(1).to({regX:0,x:120,y:508},0).to({_off:true},1).wait(1692));

	// snow
	this.snow_1 = new lib.snowi_anim();
	this.snow_1.name = "snow_1";
	this.snow_1.parent = this;
	this.snow_1.setTransform(59.15,-47.85,0.5479,0.5479,0.1532);
	this.snow_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.snow_1).wait(15).to({_off:false},0).to({_off:true},546).wait(934).to({_off:false},0).to({_off:true},266).wait(50));

	// ch1
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(-678,534);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.4,regY:0.6,scaleX:0.6402,scaleY:0.6402,x:127.75,y:299.1},0).wait(1).to({regX:-3,regY:-257.7,x:125.6,y:133.7},0).wait(1).to({scaleX:0.6404,scaleY:0.6404},0).wait(1).to({scaleX:0.6406,scaleY:0.6406,y:133.65},0).wait(1).to({scaleX:0.6409,scaleY:0.6409,y:133.7},0).wait(1).to({scaleX:0.6414,scaleY:0.6414,y:133.6},0).wait(1).to({scaleX:0.642,scaleY:0.642,x:125.55},0).wait(1).to({scaleX:0.6426,scaleY:0.6426,y:133.55},0).wait(1).to({scaleX:0.6434,scaleY:0.6434,y:133.5},0).wait(1).to({scaleX:0.6443,scaleY:0.6443,y:133.45},0).wait(1).to({scaleX:0.6454,scaleY:0.6454,x:125.6,y:133.4},0).wait(1).to({scaleX:0.6466,scaleY:0.6466,y:133.35},0).wait(1).to({scaleX:0.6479,scaleY:0.6479,y:133.25},0).wait(1).to({scaleX:0.6493,scaleY:0.6493,y:133.2},0).wait(1).to({scaleX:0.6509,scaleY:0.6509,x:125.65,y:133.1},0).wait(1).to({scaleX:0.6526,scaleY:0.6526,y:133},0).wait(1).to({scaleX:0.6544,scaleY:0.6544,y:132.85},0).wait(1).to({scaleX:0.6564,scaleY:0.6564,x:125.7,y:132.75},0).wait(1).to({scaleX:0.6585,scaleY:0.6585,x:125.65,y:132.65},0).wait(1).to({scaleX:0.6608,scaleY:0.6608,x:125.7,y:132.5},0).wait(1).to({scaleX:0.6632,scaleY:0.6632,y:132.35},0).wait(1).to({scaleX:0.6657,scaleY:0.6657,x:125.75,y:132.2},0).wait(1).to({scaleX:0.6684,scaleY:0.6684,y:132.05},0).wait(1).to({scaleX:0.6711,scaleY:0.6711,x:125.8,y:131.9},0).wait(1).to({scaleX:0.674,scaleY:0.674,y:131.7},0).wait(1).to({scaleX:0.677,scaleY:0.677,y:131.55},0).wait(1).to({scaleX:0.68,scaleY:0.68,y:131.35},0).wait(1).to({scaleX:0.6832,scaleY:0.6832,x:125.85,y:131.2},0).wait(1).to({scaleX:0.6863,scaleY:0.6863,x:125.9,y:131},0).wait(1).to({scaleX:0.6895,scaleY:0.6895,y:130.8},0).wait(1).to({scaleX:0.6927,scaleY:0.6927,y:130.65},0).wait(1).to({scaleX:0.6959,scaleY:0.6959,x:125.95,y:130.4},0).wait(1).to({scaleX:0.6991,scaleY:0.6991,y:130.25},0).wait(1).to({scaleX:0.7021,scaleY:0.7021,x:126,y:130.05},0).wait(1).to({scaleX:0.7052,scaleY:0.7052,y:129.9},0).wait(1).to({scaleX:0.7081,scaleY:0.7081,x:126.05,y:129.75},0).wait(1).to({scaleX:0.7109,scaleY:0.7109,y:129.55},0).wait(1).to({scaleX:0.7136,scaleY:0.7136,y:129.4},0).wait(1).to({scaleX:0.7162,scaleY:0.7162,x:126.1,y:129.25},0).wait(1).to({scaleX:0.7186,scaleY:0.7186,y:129.1},0).wait(1).to({scaleX:0.7208,scaleY:0.7208,x:126.15,y:128.95},0).wait(1).to({scaleX:0.7229,scaleY:0.7229,y:128.85},0).wait(1).to({scaleX:0.7248,scaleY:0.7248,y:128.7},0).wait(1).to({scaleX:0.7266,scaleY:0.7266,y:128.6},0).wait(1).to({scaleX:0.7282,scaleY:0.7282,y:128.55},0).wait(1).to({scaleX:0.7296,scaleY:0.7296,y:128.45},0).wait(1).to({scaleX:0.7309,scaleY:0.7309,x:126.2,y:128.35},0).wait(1).to({scaleX:0.732,scaleY:0.732,y:128.3},0).wait(1).to({scaleX:0.7329,scaleY:0.7329},0).wait(1).to({scaleX:0.7337,scaleY:0.7337,y:128.25},0).wait(1).to({scaleX:0.7343,scaleY:0.7343,y:128.15},0).wait(1).to({scaleX:0.7348,scaleY:0.7348},0).wait(1).to({scaleX:0.7351,scaleY:0.7351,y:128.1},0).wait(1).to({scaleX:0.7353,scaleY:0.7353},0).wait(1).to({regX:0.6,regY:1,scaleX:0.7354,scaleY:0.7354,x:128.75,y:318.1},0).wait(30).to({regX:0.9,regY:1.1,scaleX:0.6639,scaleY:0.6639,x:127.65,y:293},44,cjs.Ease.quadInOut).wait(418).to({alpha:0},13,cjs.Ease.quadOut).to({_off:true},1).wait(1236));

	// snow2
	this.snow2_1 = new lib.snowi_anim_2();
	this.snow2_1.name = "snow2_1";
	this.snow2_1.parent = this;
	this.snow2_1.setTransform(-62.25,-42.75,0.4824,0.5064,0.1468,0,0,-219.1,15.2);
	this.snow2_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.snow2_1).wait(15).to({_off:false},0).to({_off:true},546).wait(1250));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(15).to({_off:false},0).to({_off:true},546).wait(1250));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-980,0);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.2,regY:-0.3,scaleX:0.82,scaleY:0.82,x:-114.35,y:-95.6},0).wait(1).to({regX:306,regY:350,scaleX:0.8199,scaleY:0.8199,x:136.75,y:191.65},0).wait(1).to({scaleX:0.8198,scaleY:0.8198,x:136.7},0).wait(1).to({scaleX:0.8195,scaleY:0.8195,y:191.7},0).wait(1).to({scaleX:0.8192,scaleY:0.8192,x:136.65,y:191.65},0).wait(1).to({scaleX:0.8187,scaleY:0.8187},0).wait(1).to({scaleX:0.8181,scaleY:0.8181,x:136.6},0).wait(1).to({scaleX:0.8174,scaleY:0.8174},0).wait(1).to({scaleX:0.8166,scaleY:0.8166,x:136.55},0).wait(1).to({scaleX:0.8157,scaleY:0.8157,x:136.45},0).wait(1).to({scaleX:0.8146,scaleY:0.8146,x:136.4,y:191.6},0).wait(1).to({scaleX:0.8135,scaleY:0.8135,x:136.3,y:191.65},0).wait(1).to({scaleX:0.8122,scaleY:0.8122,x:136.25,y:191.6},0).wait(1).to({scaleX:0.8108,scaleY:0.8108,x:136.1,y:191.65},0).wait(1).to({scaleX:0.8093,scaleY:0.8093,x:136.05},0).wait(1).to({scaleX:0.8076,scaleY:0.8076,x:135.95,y:191.6},0).wait(1).to({scaleX:0.8059,scaleY:0.8059,x:135.8,y:191.65},0).wait(1).to({scaleX:0.804,scaleY:0.804,x:135.65},0).wait(1).to({scaleX:0.802,scaleY:0.802,x:135.55},0).wait(1).to({scaleX:0.7999,scaleY:0.7999,x:135.4,y:191.6},0).wait(1).to({scaleX:0.7977,scaleY:0.7977,x:135.25,y:191.65},0).wait(1).to({scaleX:0.7954,scaleY:0.7954,x:135.1},0).wait(1).to({scaleX:0.793,scaleY:0.793,x:134.95,y:191.6},0).wait(1).to({scaleX:0.7905,scaleY:0.7905,x:134.8,y:191.55},0).wait(1).to({scaleX:0.788,scaleY:0.788,x:134.6,y:191.6},0).wait(1).to({scaleX:0.7854,scaleY:0.7854,x:134.45,y:191.55},0).wait(1).to({scaleX:0.7827,scaleY:0.7827,x:134.25,y:191.6},0).wait(1).to({scaleX:0.78,scaleY:0.78,x:134.1},0).wait(1).to({scaleX:0.7773,scaleY:0.7773,x:133.9,y:191.55},0).wait(1).to({scaleX:0.7746,scaleY:0.7746,x:133.7},0).wait(1).to({scaleX:0.7719,scaleY:0.7719,x:133.55},0).wait(1).to({scaleX:0.7692,scaleY:0.7692,x:133.35},0).wait(1).to({scaleX:0.7665,scaleY:0.7665,x:133.2},0).wait(1).to({scaleX:0.7639,scaleY:0.7639,x:133},0).wait(1).to({scaleX:0.7614,scaleY:0.7614,x:132.9},0).wait(1).to({scaleX:0.7589,scaleY:0.7589,x:132.7},0).wait(1).to({scaleX:0.7566,scaleY:0.7566,x:132.55},0).wait(1).to({scaleX:0.7543,scaleY:0.7543,x:132.4,y:191.5},0).wait(1).to({scaleX:0.7521,scaleY:0.7521,x:132.25},0).wait(1).to({scaleX:0.7501,scaleY:0.7501,x:132.15,y:191.55},0).wait(1).to({scaleX:0.7482,scaleY:0.7482,x:132,y:191.5},0).wait(1).to({scaleX:0.7464,scaleY:0.7464,x:131.9},0).wait(1).to({scaleX:0.7447,scaleY:0.7447,x:131.8},0).wait(1).to({scaleX:0.7432,scaleY:0.7432,x:131.65},0).wait(1).to({scaleX:0.7418,scaleY:0.7418,x:131.6},0).wait(1).to({scaleX:0.7405,scaleY:0.7405,x:131.5},0).wait(1).to({scaleX:0.7394,scaleY:0.7394,x:131.4},0).wait(1).to({scaleX:0.7385,scaleY:0.7385,x:131.35},0).wait(1).to({scaleX:0.7376,scaleY:0.7376,x:131.3,y:191.45},0).wait(1).to({scaleX:0.7369,scaleY:0.7369,x:131.25},0).wait(1).to({scaleX:0.7363,scaleY:0.7363,x:131.2},0).wait(1).to({scaleX:0.7359,scaleY:0.7359},0).wait(1).to({scaleX:0.7356,scaleY:0.7356,x:131.15,y:191.5},0).wait(1).to({scaleX:0.7354,scaleY:0.7354},0).wait(1).to({regX:-0.2,regY:-0.2,x:-94.05,y:-66.1},0).wait(30).to({regX:-0.3,regY:-0.4,scaleX:0.6639,scaleY:0.6639,x:-73.1,y:-58.4},44,cjs.Ease.quadInOut).wait(418).to({alpha:0},13,cjs.Ease.quadOut).to({_off:true},1).wait(1236));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(688.3,158.35,0.3,0.3,0,0,0,1,1.2);
	this.ch2.alpha = 0.0117;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(561).to({regX:0.9,regY:1.1,scaleX:0.77,scaleY:0.77,x:127.7,y:322.8,alpha:1},0).wait(1).to({regX:-3,regY:-257.7,x:124.7,y:123.55},0).wait(1).to({y:123.65},0).wait(1).to({y:123.75},0).wait(1).to({y:124},0).wait(1).to({y:124.25},0).wait(1).to({y:124.6},0).wait(1).to({y:125},0).wait(1).to({y:125.5},0).wait(1).to({y:126.05},0).wait(1).to({y:126.65},0).wait(1).to({y:127.3},0).wait(1).to({y:128},0).wait(1).to({y:128.65},0).wait(1).to({y:129.3},0).wait(1).to({y:129.9},0).wait(1).to({y:130.4},0).wait(1).to({y:130.85},0).wait(1).to({y:131.15},0).wait(1).to({y:131.4},0).wait(1).to({y:131.55},0).wait(1).to({regX:0.9,regY:1.1,x:127.7,y:330.85},0).wait(156).to({regX:-3,regY:-257.7,scaleX:0.7701,scaleY:0.7701,x:124.7,y:131.55},0).wait(1).to({scaleX:0.7705,scaleY:0.7705},0).wait(1).to({scaleX:0.7711,scaleY:0.7711},0).wait(1).to({scaleX:0.772,scaleY:0.772,y:131.5},0).wait(1).to({scaleX:0.7732,scaleY:0.7732},0).wait(1).to({scaleX:0.7746,scaleY:0.7746},0).wait(1).to({scaleX:0.7764,scaleY:0.7764,x:124.65,y:131.45},0).wait(1).to({scaleX:0.7784,scaleY:0.7784,y:131.4},0).wait(1).to({scaleX:0.7808,scaleY:0.7808},0).wait(1).to({scaleX:0.7834,scaleY:0.7834,y:131.3},0).wait(1).to({scaleX:0.7864,scaleY:0.7864},0).wait(1).to({scaleX:0.7897,scaleY:0.7897,y:131.25},0).wait(1).to({scaleX:0.7932,scaleY:0.7932,x:124.6,y:131.2},0).wait(1).to({scaleX:0.7971,scaleY:0.7971,y:131.1},0).wait(1).to({scaleX:0.8012,scaleY:0.8012,x:124.65,y:131.05},0).wait(1).to({scaleX:0.8055,scaleY:0.8055,y:130.95},0).wait(1).to({scaleX:0.8101,scaleY:0.8101,x:124.6,y:130.9},0).wait(1).to({scaleX:0.8148,scaleY:0.8148,y:130.85},0).wait(1).to({scaleX:0.8195,scaleY:0.8195,y:130.75},0).wait(1).to({scaleX:0.8244,scaleY:0.8244,y:130.65},0).wait(1).to({scaleX:0.8292,scaleY:0.8292,y:130.55},0).wait(1).to({scaleX:0.834,scaleY:0.834,y:130.5},0).wait(1).to({scaleX:0.8386,scaleY:0.8386,y:130.45},0).wait(1).to({scaleX:0.843,scaleY:0.843,x:124.55,y:130.35},0).wait(1).to({scaleX:0.8472,scaleY:0.8472,y:130.3},0).wait(1).to({scaleX:0.8511,scaleY:0.8511,y:130.2},0).wait(1).to({scaleX:0.8547,scaleY:0.8547,y:130.15},0).wait(1).to({scaleX:0.8579,scaleY:0.8579,x:124.6,y:130.1},0).wait(1).to({scaleX:0.8608,scaleY:0.8608,x:124.55,y:130.05},0).wait(1).to({scaleX:0.8633,scaleY:0.8633},0).wait(1).to({scaleX:0.8654,scaleY:0.8654,y:130},0).wait(1).to({scaleX:0.8671,scaleY:0.8671,y:129.95},0).wait(1).to({scaleX:0.8684,scaleY:0.8684},0).wait(1).to({scaleX:0.8693,scaleY:0.8693},0).wait(1).to({scaleX:0.8698,scaleY:0.8698,y:129.9},0).wait(1).to({regX:1.1,regY:1.3,scaleX:0.87,scaleY:0.87,x:127.95,y:355.15},0).wait(273).to({regX:1.3,regY:1.4,scaleX:0.77,scaleY:0.77,x:128,y:326.1},45,cjs.Ease.quadInOut).wait(331).to({regX:1.4,regY:1.5,scaleX:0.866,scaleY:0.866,x:127.75,y:349.85},41,cjs.Ease.quadInOut).wait(32).to({regX:1.8,regY:1.8,scaleX:0.46,scaleY:0.46,x:125.85,y:241.85},0).to({_off:true},266).wait(50));

	// snow2
	this.snow2_2 = new lib.snowi_anim_2();
	this.snow2_2.name = "snow2_2";
	this.snow2_2.parent = this;
	this.snow2_2.setTransform(-62.25,-42.75,0.4824,0.5064,0.1468,0,0,-219.1,15.2);
	this.snow2_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.snow2_2).wait(1495).to({_off:false},0).to({_off:true},266).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(561).to({_off:false},0).to({_off:true},1200).wait(50));

	// bg2
	this.bg1_1 = new lib.bg_zoom_half_blur();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-106.15,-89.2,0.77,0.77,0,0,0,-0.2,-0.2);
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(561).to({_off:false},0).wait(1).to({regX:306,regY:350,x:129.6,y:180.5},0).wait(1).to({y:180.6},0).wait(1).to({y:180.7},0).wait(1).to({y:180.95},0).wait(1).to({y:181.2},0).wait(1).to({y:181.55},0).wait(1).to({y:181.95},0).wait(1).to({y:182.45},0).wait(1).to({y:183},0).wait(1).to({y:183.6},0).wait(1).to({y:184.25},0).wait(1).to({y:184.95},0).wait(1).to({y:185.6},0).wait(1).to({y:186.25},0).wait(1).to({y:186.85},0).wait(1).to({y:187.35},0).wait(1).to({y:187.8},0).wait(1).to({y:188.1},0).wait(1).to({y:188.35},0).wait(1).to({y:188.5},0).wait(1).to({regX:-0.2,regY:-0.2,x:-106.15,y:-81.15},0).wait(156).to({regX:306,regY:350,scaleX:0.7701,scaleY:0.7701,x:129.65,y:188.5},0).wait(1).to({scaleX:0.7704,scaleY:0.7704,y:188.55},0).wait(1).to({scaleX:0.7711,scaleY:0.7711,y:188.6},0).wait(1).to({scaleX:0.772,scaleY:0.772,x:129.6},0).wait(1).to({scaleX:0.7731,scaleY:0.7731,x:129.65,y:188.65},0).wait(1).to({scaleX:0.7746,scaleY:0.7746,x:129.7,y:188.75},0).wait(1).to({scaleX:0.7763,scaleY:0.7763,x:129.65,y:188.8},0).wait(1).to({scaleX:0.7784,scaleY:0.7784,x:129.7,y:188.95},0).wait(1).to({scaleX:0.7808,scaleY:0.7808,y:189.05},0).wait(1).to({scaleX:0.7834,scaleY:0.7834,x:129.75,y:189.2},0).wait(1).to({scaleX:0.7864,scaleY:0.7864,y:189.35},0).wait(1).to({scaleX:0.7897,scaleY:0.7897,y:189.5},0).wait(1).to({scaleX:0.7932,scaleY:0.7932,x:129.8,y:189.7},0).wait(1).to({scaleX:0.7971,scaleY:0.7971,y:189.9},0).wait(1).to({scaleX:0.8012,scaleY:0.8012,y:190.05},0).wait(1).to({scaleX:0.8055,scaleY:0.8055,x:129.85,y:190.3},0).wait(1).to({scaleX:0.8101,scaleY:0.8101,y:190.5},0).wait(1).to({scaleX:0.8147,scaleY:0.8147,y:190.7},0).wait(1).to({scaleX:0.8195,scaleY:0.8195,x:129.9,y:191},0).wait(1).to({scaleX:0.8244,scaleY:0.8244,x:129.95,y:191.2},0).wait(1).to({scaleX:0.8292,scaleY:0.8292,x:130,y:191.45},0).wait(1).to({scaleX:0.8339,scaleY:0.8339,y:191.65},0).wait(1).to({scaleX:0.8386,scaleY:0.8386,y:191.9},0).wait(1).to({scaleX:0.843,scaleY:0.843,x:130.05,y:192.15},0).wait(1).to({scaleX:0.8472,scaleY:0.8472,y:192.3},0).wait(1).to({scaleX:0.8511,scaleY:0.8511,x:130.1,y:192.55},0).wait(1).to({scaleX:0.8547,scaleY:0.8547,y:192.7},0).wait(1).to({scaleX:0.8579,scaleY:0.8579,y:192.85},0).wait(1).to({scaleX:0.8608,scaleY:0.8608,x:130.15,y:193},0).wait(1).to({scaleX:0.8633,scaleY:0.8633,y:193.15},0).wait(1).to({scaleX:0.8653,scaleY:0.8653,y:193.2},0).wait(1).to({scaleX:0.867,scaleY:0.867,y:193.3},0).wait(1).to({scaleX:0.8683,scaleY:0.8683,y:193.35},0).wait(1).to({scaleX:0.8692,scaleY:0.8692,x:130.2,y:193.45},0).wait(1).to({scaleX:0.8698,scaleY:0.8698},0).wait(1).to({regX:-0.3,regY:-0.3,scaleX:0.87,scaleY:0.87,x:-136.25,y:-111.25},0).wait(273).to({scaleX:0.7699,scaleY:0.7699,x:-106.25,y:-86.25},45,cjs.Ease.quadInOut).wait(331).to({regX:-0.4,regY:-0.4,scaleX:0.866,scaleY:0.866,x:-135.7,y:-113.85},41,cjs.Ease.quadInOut).to({_off:true},32).wait(316));

	// bg3
	this.bg1_2 = new lib.bg_zoom_half();
	this.bg1_2.name = "bg1_2";
	this.bg1_2.parent = this;
	this.bg1_2.setTransform(-14.2,-4.2,0.4599,0.4599,0,0,0,-0.4,-0.4);
	this.bg1_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_2).wait(1495).to({_off:false},0).to({_off:true},266).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1749).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1761).wait(45).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-860,-720,1641,1420);
// library properties:
lib.properties = {
	id: '_396_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1579254328799", id:"_396_2_bg"},
		{src:"images/bg_blur.jpg?1579254328799", id:"_396_2_bg_blur"},
		{src:"images/ch_base.png?1579254328799", id:"_396_2_ch_base"},
		{src:"images/ch_face2.jpg?1579254328799", id:"_396_2_ch_face2"},
		{src:"images/ch_face3.jpg?1579254328799", id:"_396_2_ch_face3"},
		{src:"images/ch_face4.jpg?1579254328799", id:"_396_2_ch_face4"},
		{src:"images/ch_face5.jpg?1579254328799", id:"_396_2_ch_face5"},
		{src:"images/ch_face6.jpg?1579254328799", id:"_396_2_ch_face6"},
		{src:"images/finish.jpg?1579254328799", id:"_396_2_finish"},
		{src:"images/finish_blur.jpg?1579254328799", id:"_396_2_finish_blur"},
		{src:"images/first_scene.jpg?1579254328799", id:"_396_2_first_scene"},
		{src:"images/snow1.png?1579254328800", id:"_396_2_snow1"},
		{src:"images/tie_fp.png?1579254328800", id:"_396_2_tie_fp"},
		{src:"images/tie_sp.png?1579254328800", id:"_396_2_tie_sp"}
	],
	preloads: []
};
