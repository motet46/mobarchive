...
(lib.bg = function() {
	this.initialize(img._434_3_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1100,1400);


(lib.ch_base = function() {
	this.initialize(img._434_3_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1100,1400);


(lib.ch_face10 = function() {
	this.initialize(img._434_3_ch_face10);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,280);


(lib.ch_face2 = function() {
	this.initialize(img._434_3_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,280);


(lib.ch_face3 = function() {
	this.initialize(img._434_3_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,280);


(lib.ch_face5 = function() {
	this.initialize(img._434_3_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,280);


(lib.ch_face6 = function() {
	this.initialize(img._434_3_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,280);


(lib.ch_face7 = function() {
	this.initialize(img._434_3_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,280);


(lib.ch_face8 = function() {
	this.initialize(img._434_3_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,280);


(lib.ch_face9 = function() {
	this.initialize(img._434_3_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,280);


(lib.finish = function() {
	this.initialize(img._434_3_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._434_3_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._434_3_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._434_3_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.grd_core = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#0070FF","rgba(0,216,255,0)","rgba(0,255,255,0)"],[0,0.729,1],0,0,0,0,0,290.6).s().p("A/1atQtNrEAAvpQAAvoNNrEQNMrESpAAQSqAANMLEQNNLEAAPoQAAPptNLEQtMLEyqAAQypAAtMrEg");
	this.shape.setTransform(288.25,241.725);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.grd_core, new cjs.Rectangle(0,0,576.5,483.5), null);
...
(lib.grd_anim = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.grd_core();
	this.instance.parent = this;
	this.instance.setTransform(288.3,241.7,1,1,0,0,0,288.3,241.7);
	this.instance.alpha = 0.3008;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:288.1,scaleX:1.01,scaleY:1.01,x:288.25,alpha:0.3516},2).to({regX:288.3,scaleX:1,scaleY:1,x:288.3,alpha:0.3008},2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.7,-2.4,582.2,488.29999999999995);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AggA5IATgBQAGgBACgCQACgCAAgDIAAgtIhGAAIAAgOIBGAAIAAgZIAIAAIAMgHIARgNIhbAAIAAgPIBzAAIAAANQgGAHgHAGIgNALIgMAHIgHAEIAAAMIA9AAIAAAOIg9AAIAAAwQAAAHgDAFQgEAFgIACQgIACgPAAg");
	this.shape_3.setTransform(-15.975,0.675);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(88.65,50.35,1.3227,0.67,-56.0008,0,0,0.2,0);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(8).to({_off:false},0).wait(1).to({_off:true},1).wait(9).to({_off:false,regX:0,scaleX:0.9005,scaleY:0.5503,rotation:0,skewX:26.0791,skewY:25.8338,x:87,y:41.9},0).wait(1));

	// moisture_righteye
	this.instance_1 = new lib.uru_set();
	this.instance_1.parent = this;
	this.instance_1.setTransform(30.45,77.8,1.2044,0.6,-54.0012,0,0,0.7,4.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(8).to({_off:false},0).wait(1).to({_off:true},1).wait(9).to({_off:false,regY:4.2,scaleX:1.0632,scaleY:0.5296,rotation:0,skewX:32.5646,skewY:37.1205,x:34.65,y:40.95},0).wait(1));

	// mask_face (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Aq2LBIAA13IV3AAIAAV3g");
	mask.setTransform(70.5116,70.5116);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).wait(8));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-92,246);
...
(lib.bg_zoom_half = function(mode,startPosition,loop) {
	...
	// レイヤー_2
	this.instance = new lib.grd_anim();
	this.instance.parent = this;
	this.instance.setTransform(72.35,309.15,1,1,0,0,0,288.3,241.7);
...
p.nominalBounds = new cjs.Rectangle(-215.9,0,765.9,700);
...
(lib.ef_kira_set = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// kira コピー 10
	this.instance = new lib.gｌitter_rise_core();
	this.instance.parent = this;
	this.instance.setTransform(10.7,52.25);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-76.8,68);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-43.35,10.5);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(-69.35,-6.25);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(-53.15,36.75,0.5337,0.5337,0,0,0,-0.1,0);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(-22.75,15.15,0.5855,0.5855);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(-43.35,45.5);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(-87.75,18.9,1.7333,1.7333,0,0,0,0,0.1);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(34.2,-24.25);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(29.5,32.6,0.5078,0.5078,0,0,0,0.1,0.1);
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(12.05,14.15,1.3104,1.3104,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1));

}).prototype = getMCSymbolPrototype(lib.ef_kira_set, new cjs.Rectangle(-104.5,-35.5,148.4,114.8), null);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 0, 1, 1, 0, 0, 1, 1, 1, 1, 0, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AnsFGQg6gdgXg7QgdhIA6hHQBGhXA/gnQBLgwBfgDQBjgEApgRQAjgOBshOQCPhmARgJQBDgkBbAHQB6AJAmAQQA4AXAABFQAAAYAFAoQAFAggDAOQgHAohbAfQhfAgh9AUQhmARhHADQg2ACgVAIQgPAGgPAUQgmAugvAyQhdBkgvAVQhFAeg/ANQgiAGgcAAQgkAAgYgLg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:64.5974,y:61.4834}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:70.5,regY:70.5,x:70.5,y:70.5,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:70.5,regY:70.5,x:70.5,y:70.5,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-212,-150,550,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-99.75,-373.75,1.1645,1.1645);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-125.35,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-137,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-99.75,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-125.35,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-137,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-99.75,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-125.35,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-137,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-99.75,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-125.35,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-137,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(110));

	// effect
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-45.6,-279.6,1.4808,1.4808);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-45.6,-279.6,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-144.3,-334.75,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-138.2,-364.35,1.4204,1.4204,35.8424,0,0,-30.3,20.6);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-110.4,-282,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-111.05,-366.6,1.053,1.053,-28.4906);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-113.3,-381.3,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-107.8,-362.7,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-101.55,-364,0.9876,0.9876,14.9998);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-111.15,-367.65,1.3878,1.3878,-121.2396);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-88.65,-213.25);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-110.45,-322.85,0.4532,0.4532);
	this.instance_12._off = true;

	this.instance_13 = new lib.angry("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(27.5,-342.95,0.5276,0.5276);
	this.instance_13._off = true;

	this.instance_14 = new lib.mc_punpun();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-103.55,-392.1,1.1377,1.1377);

	this.instance_15 = new lib.concent_wrapper("synched",0,false);
	this.instance_15.parent = this;
	this.instance_15.setTransform(-45.85,-280.15,1,1,0,0,0,-0.5,-0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-143.9,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-144.3,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,x:-117.3,y:-369.65},0).wait(3).to({regX:-28.8,regY:20.5,x:-116.9,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-117.3,alpha:0},0).to({_off:true},1).wait(283));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-140.7,y:-363.5,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-138.2,y:-364.35,alpha:0,startPosition:19},0).to({_off:true},1).wait(262));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-118,y:-380,alpha:0.5556},0).wait(1).to({x:-122.1,y:-388.25,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-123.4,y:-391.3,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-123.15,y:-390.35},0).wait(1).to({x:-122.15,y:-388.5},0).wait(1).to({x:-120.45,y:-385.35},0).wait(1).to({regX:0,regY:0,x:-118,y:-381.3},0).to({x:-118.75,y:-382.65},2).wait(8).to({regX:-0.2,regY:0.2,x:-118.5,y:-381.75,alpha:0.9298},0).wait(1).to({x:-117.45,y:-379.8,alpha:0.692},0).wait(1).to({x:-115.85,y:-376.9,alpha:0.339},0).wait(1).to({x:-114.7,y:-374.75,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-114.25,y:-374.45,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-111.5,y:-366.2},0).wait(1).to({regX:-0.2,regY:0.2,x:-118.45,y:-379.6,alpha:0.5556},0).wait(1).to({x:-122.55,y:-387.85,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-123.85,y:-390.9,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-123.6,y:-389.95},0).wait(1).to({x:-122.6,y:-388.1},0).wait(1).to({x:-120.9,y:-384.95},0).wait(1).to({regX:0,regY:0,x:-118.45,y:-380.9},0).to({x:-119.2,y:-382.25},2).wait(3).to({regX:-0.2,regY:0.2,x:-118.95,y:-381.35,alpha:0.9298},0).wait(1).to({x:-117.9,y:-379.4,alpha:0.692},0).wait(1).to({x:-116.3,y:-376.5,alpha:0.339},0).wait(1).to({x:-115.15,y:-374.35,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-114.7,y:-374.05,alpha:0},0).to({_off:true},1).wait(195));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-106.8,y:-359},0).wait(1).to({y:-355.15},0).wait(1).to({y:-351.9},0).wait(1).to({y:-349.25},0).wait(1).to({y:-347.15},0).wait(1).to({y:-345.65},0).wait(1).to({y:-344.75},0).wait(1).to({regX:-0.5,regY:0.2,x:-107.8,y:-343.7},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-106.8,y:-344.5,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-107.8,y:-343.7,alpha:0},0).to({_off:true},1).wait(153));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-132.975,y:-359.3875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-143.45,y:-357.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-101.55,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-132.975,y:-363.775,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-143.45,y:-363.7,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-101.55,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-132.975,y:-359.3875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-143.45,y:-357.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-101.55,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-132.975,y:-363.775,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-143.45,y:-363.7,alpha:0.2188},0).to({_off:true},1).wait(110));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:-89.65,y:-212.25,alpha:1},0).wait(1).to({regX:0.9,x:-89.75,y:-211.3,alpha:0.8965},0).wait(1).to({x:-91.1,y:-210.1,alpha:0.7636},0).wait(1).to({x:-92.7,y:-208.65,alpha:0.6048},0).wait(1).to({x:-94.5,y:-207.05,alpha:0.4229},0).wait(1).to({x:-96.5,y:-205.2,alpha:0.2205},0).wait(1).to({regX:0,x:-99.65,y:-203.25,alpha:0},0).to({_off:true},1).wait(83));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-112.2,y:-337},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-115.45,y:-342.85},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-112.9,y:-340.7},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-112.35,y:-337.45},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-113.45,y:-332.85},0).to({scaleX:1,scaleY:1,x:-114.45,y:-336.85},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-111.85,y:-335.85,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-113.45,y:-336.6,alpha:0.1016},0).to({_off:true},1).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-48,regY:-144,x:-48,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-149.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-149.75},0).wait(1).to({y:-142.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-140.75},0).wait(1).to({y:-143.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-143.1},0).wait(1).to({y:-143.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-153},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-156.95},0).wait(1).to({y:-153.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-142},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-144.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-153},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-156.95},0).wait(1).to({y:-153.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-142},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-144.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-48,regY:-144,x:-48,y:-143.4},0).wait(1).to({y:-141},0).wait(1).to({y:-138.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-138.65},0).wait(1).to({y:-141},0).wait(1).to({y:-143.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-48,regY:-144,x:-48,y:-143.85},0).wait(1).to({y:-143.3},0).wait(1).to({y:-142.2},0).wait(1).to({y:-140.85},0).wait(1).to({y:-139.75},0).wait(1).to({y:-139.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-139.2},0).wait(1).to({y:-139.75},0).wait(1).to({y:-140.85},0).wait(1).to({y:-142.2},0).wait(1).to({y:-143.3},0).wait(1).to({y:-143.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-48,regY:-144,x:-48,y:-139.25},0).wait(1).to({y:-142.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-48,regY:-144,x:-48,y:-141.8},0).wait(1).to({y:-143.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-48,regY:-144,rotation:-0.0253,x:-48.1,y:-144},0).wait(1).to({rotation:-0.1129,x:-48.5,y:-143.9},0).wait(1).to({rotation:-0.2845,x:-49.25,y:-143.75},0).wait(1).to({rotation:-0.5565,x:-50.5,y:-143.6},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-52.1,y:-143.3},0).wait(1).to({rotation:-1.2075,x:-53.5,y:-143.1},0).wait(1).to({rotation:-1.4141,x:-54.45,y:-142.9},0).wait(1).to({rotation:-1.5201,x:-54.9,y:-142.85},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-3.2,y:-0.2},0).wait(1).to({regX:-48,regY:-144,rotation:-1.5305,x:-55,y:-142.8},0).wait(1).to({rotation:-1.4624,x:-54.65,y:-142.9},0).wait(1).to({rotation:-1.3309,x:-54.05,y:-143},0).wait(1).to({rotation:-1.121,x:-53.1,y:-143.1},0).wait(1).to({rotation:-0.8372,x:-51.8,y:-143.35},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-50.4,y:-143.6},0).wait(1).to({rotation:-0.2881,x:-49.25,y:-143.75},0).wait(1).to({rotation:-0.1291,x:-48.5,y:-143.9},0).wait(1).to({rotation:-0.0467,x:-48.15,y:-143.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-48,regY:-144,rotation:-0.0253,x:-48.1,y:-144},0).wait(1).to({rotation:-0.1129,x:-48.5,y:-143.9},0).wait(1).to({rotation:-0.2845,x:-49.25,y:-143.75},0).wait(1).to({rotation:-0.5565,x:-50.5,y:-143.6},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-52.1,y:-143.3},0).wait(1).to({rotation:-1.2075,x:-53.5,y:-143.1},0).wait(1).to({rotation:-1.4141,x:-54.45,y:-142.9},0).wait(1).to({rotation:-1.5201,x:-54.9,y:-142.85},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-3.2,y:-0.2},0).wait(1).to({regX:-48,regY:-144,rotation:-1.5302,x:-55,y:-142.8},0).wait(1).to({rotation:-1.461,x:-54.65,y:-142.9},0).wait(1).to({rotation:-1.3276,x:-54.05,y:-143},0).wait(1).to({rotation:-1.1146,x:-53.1,y:-143.1},0).wait(1).to({rotation:-0.8266,x:-51.8,y:-143.35},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:-50.35,y:-143.6},0).wait(1).to({rotation:-0.2693,x:-49.25,y:-143.75},0).wait(1).to({rotation:-0.1079,x:-48.45,y:-143.9},0).wait(1).to({rotation:-0.0243,x:-48.1,y:-144},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:-48,regY:-144,x:-48,y:-149.55},0).wait(1).to({y:-151.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-151.35},0).wait(1).to({y:-149.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-48,regY:-144,x:-48,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(35).to({regX:-48,regY:-144,rotation:-0.147,x:-48.2,y:-143.45},0).wait(1).to({rotation:-0.7239,x:-48.9,y:-141.1},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:-49.7,y:-138.4},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:-48,regY:-144,rotation:-1.4913,x:-49.85,y:-137.9},0).wait(1).to({rotation:-1.2701,x:-49.6,y:-138.85},0).wait(1).to({rotation:-0.8372,x:-49.05,y:-140.6},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-48.5,y:-142.6},0).wait(1).to({rotation:-0.094,x:-48.2,y:-143.7},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-48,regY:-144,rotation:-0.0894,x:-48.1,y:-143.7},0).wait(1).to({rotation:-0.4358,x:-48.55,y:-142.25},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:-49.3,y:-139.8},0).wait(1).to({rotation:-1.4426,x:-49.75,y:-138.1},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:-48,regY:-144,rotation:-1.4913,x:-49.85,y:-137.9},0).wait(1).to({rotation:-1.2701,x:-49.6,y:-138.85},0).wait(1).to({rotation:-0.8372,x:-49.05,y:-140.6},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-48.5,y:-142.6},0).wait(1).to({rotation:-0.094,x:-48.2,y:-143.7},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-48,regY:-144,x:-50.75,y:-136.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-48,regY:-144,x:-48,y:-131.75},0).wait(1).to({y:-134.7},0).wait(1).to({y:-139.65},0).wait(1).to({y:-143.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-143},0).wait(1).to({y:-137.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-48,regY:-144,x:-48,y:-136.2},0).wait(1).to({y:-140.5},0).wait(1).to({y:-144.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-144.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-48,regY:-144,x:-48,y:-150.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-150.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-48,regY:-144,x:-50.75,y:-136.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-48,regY:-144,x:-48,y:-133.25},0).wait(1).to({y:-141},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-145},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-144.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-143.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-48,regY:-144,x:-48,y:-143.4},0).wait(1).to({y:-141},0).wait(1).to({y:-138.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-138.6},0).wait(1).to({y:-138.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-48,regY:-144,x:-48,y:-139.4},0).wait(1).to({y:-140.9},0).wait(1).to({y:-143.15},0).wait(1).to({y:-144.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-144.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-151.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-48,regY:-144,x:-48,y:-151.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:-48,regY:-144,x:-48,y:-152},0).wait(1).to({y:-146},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:-48,regY:-144,x:-48,y:-139.35},0).wait(1).to({y:-140.55},0).wait(1).to({y:-142.5},0).wait(1).to({y:-143.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-48,regY:-144,x:-48,y:-143.1},0).wait(1).to({y:-143.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-48,regY:-144,x:-45,y:-140.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-48,regY:-144,x:-48.85,y:-134.55},0).wait(1).to({x:-48.2,y:-134.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-48,regY:-144,x:-48,y:-134.7},0).wait(1).to({y:-137.15},0).wait(1).to({y:-140.85},0).wait(1).to({y:-143.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-680.4,818.7,904.0999999999999);
...
// stage content:
(lib._434_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:243,scene2:244,end2:490,scene3:491,end3:704,scene4:705,end4:931,scene5:932,end5:1132,scene6:1133,end6:1330,scene7:1331,end7:1535});
	...
	this.frame_71 = function() {
		exportRoot._g.m1 = "ｿﾜｿﾜ……ﾊｯﾋﾟｰ……ﾌﾋ､";
		exportRoot._u.setText();
	...
	this.frame_252 = function() {
		exportRoot._g.m1 = "こ､これか? ";
		exportRoot._u.setText();
	}
	this.frame_276 = function() {
		exportRoot._g.m1 = "こ､これか? これはな……";
		exportRoot._u.setText();
	}
	...
	this.frame_547 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "めていたところだ……｡";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch1", 8);
	}
	this.frame_590 = function() {
		exportRoot._g.m2 = "めていたところだ……｡ﾌﾋ､";
		exportRoot._u.setText();
	...
	this.frame_609 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "可愛いな……";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch1", 8);
	}
	this.frame_649 = function() {
		exportRoot._g.m3 = "可愛いな……ﾘﾎﾞﾝとか､";
		exportRoot._u.setText();
	}
	...
	this.frame_948 = function() {
		exportRoot._g.m1 = "ただ､今は……";
		exportRoot._u.setText();
	}
	this.frame_963 = function() {
		exportRoot._g.m1 = "ただ､今は……ﾀﾞﾒだ｡";
		exportRoot._u.setText();
	...
	this.frame_987 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "ﾄﾓﾁｮｺを見て､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 8);
	}
	this.frame_1020 = function() {
		exportRoot._g.m2 = "ﾄﾓﾁｮｺを見て､思ったんだ｡";
		exportRoot._u.setText();
	...
	this.frame_1258 = function() {
		exportRoot._g.m3 = "嬉しい……｡ﾗｯﾋﾟﾝｸﾞとか､";
		exportRoot._u.setText();
	...
	this.frame_1330 = function() {
		exportRoot._u.updateTalk();
		
		exportRoot._u.setFace("ch2", 1);
	}
	this.frame_1331 = function() {
		exportRoot._g.m1 = "大親友のﾌﾟﾛﾃﾞｭｰｻｰに相応しい､";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_1391 = function() {
		exportRoot._g.m2 = "星輝子ｽﾍﾟｼｬﾙﾄﾓﾁｮｺ……｡";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(34).call(this.frame_49).wait(22).call(this.frame_71).wait(13).call(this.frame_84).wait(36).call(this.frame_120).wait(12).call(this.frame_132).wait(28).call(this.frame_160).wait(23).call(this.frame_183).wait(40).call(this.frame_223).wait(20).call(this.frame_243).wait(1).call(this.frame_244).wait(8).call(this.frame_252).wait(24).call(this.frame_276).wait(32).call(this.frame_308).wait(37).call(this.frame_345).wait(32).call(this.frame_377).wait(51).call(this.frame_428).wait(7).call(this.frame_435).wait(29).call(this.frame_464).wait(26).call(this.frame_490).wait(1).call(this.frame_491).wait(38).call(this.frame_529).wait(18).call(this.frame_547).wait(43).call(this.frame_590).wait(19).call(this.frame_609).wait(40).call(this.frame_649).wait(28).call(this.frame_677).wait(27).call(this.frame_704).wait(1).call(this.frame_705).wait(35).call(this.frame_740).wait(29).call(this.frame_769).wait(31).call(this.frame_800).wait(19).call(this.frame_819).wait(39).call(this.frame_858).wait(28).call(this.frame_886).wait(18).call(this.frame_904).wait(27).call(this.frame_931).wait(1).call(this.frame_932).wait(16).call(this.frame_948).wait(15).call(this.frame_963).wait(24).call(this.frame_987).wait(33).call(this.frame_1020).wait(34).call(this.frame_1054).wait(27).call(this.frame_1081).wait(28).call(this.frame_1109).wait(23).call(this.frame_1132).wait(1).call(this.frame_1133).wait(15).call(this.frame_1148).wait(37).call(this.frame_1185).wait(22).call(this.frame_1207).wait(26).call(this.frame_1233).wait(25).call(this.frame_1258).wait(22).call(this.frame_1280).wait(32).call(this.frame_1312).wait(1).call(this.frame_1313).wait(17).call(this.frame_1330).wait(1).call(this.frame_1331).wait(60).call(this.frame_1391).wait(24).call(this.frame_1415).wait(45).call(this.frame_1460).wait(10).call(this.frame_1470).wait(17).call(this.frame_1487).wait(48).call(this.frame_1535).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1535).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1540));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1521));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1525));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1534));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1420).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1460).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1460).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1460).to({_off:false},0).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1460).to({_off:false},0).to({alpha:0.0117},17).to({_off:true},1).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1460).to({_off:false},0).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1448).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(228).to({_off:false,alpha:0.0117},0).to({alpha:1},5).to({alpha:0.1016},3).to({_off:true},1).wait(82).to({_off:false,alpha:0.0117},0).to({alpha:1},7).to({alpha:0},7).to({_off:true},1).wait(978).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(201));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13},{t:this.instance_12}]}).to({state:[]},15).wait(1525));

	// overlay_top
	this.instance_14 = new lib.overlay_black();
	this.instance_14.parent = this;
	this.instance_14.setTransform(120,-113);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(252).to({_off:false},0).to({_off:true},93).wait(1195));

	// overlay_bottom
	this.instance_15 = new lib.overlay_black();
	this.instance_15.parent = this;
	this.instance_15.setTransform(120,350);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(252).to({_off:false},0).to({_off:true},93).wait(1195));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(15).to({_off:false},0).wait(1525));

	// kirakira
	this.instance_17 = new lib.ef_kira_set();
	this.instance_17.parent = this;
	this.instance_17.setTransform(134.25,115.35,1,1,0,0,0,9.7,11.3);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(252).to({_off:false},0).to({x:140.1},93).to({_off:true},1).wait(1194));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.2,regY:0.2,scaleX:0.7894,scaleY:0.7894,x:152.45,y:317.95},0).wait(1).to({regX:-44,regY:-231.3,x:117.55,y:135.2},0).wait(2).to({y:135.25},0).wait(1).to({y:135.35},0).wait(1).to({y:135.45},0).wait(1).to({y:135.55},0).wait(1).to({y:135.7},0).wait(1).to({y:135.9},0).wait(1).to({y:136.1},0).wait(1).to({y:136.4},0).wait(1).to({y:136.7},0).wait(1).to({y:137},0).wait(1).to({y:137.4},0).wait(1).to({y:137.85},0).wait(1).to({y:138.35},0).wait(1).to({y:138.95},0).wait(1).to({y:139.55},0).wait(1).to({y:140.25},0).wait(1).to({y:141},0).wait(1).to({y:141.75},0).wait(1).to({y:142.55},0).wait(1).to({y:143.3},0).wait(1).to({y:144.05},0).wait(1).to({y:144.75},0).wait(1).to({y:145.35},0).wait(1).to({y:145.9},0).wait(1).to({y:146.3},0).wait(1).to({y:146.7},0).wait(1).to({y:147},0).wait(1).to({y:147.2},0).wait(1).to({y:147.4},0).wait(1).to({y:147.5},0).wait(1).to({y:147.55},0).wait(1).to({regX:0.2,regY:0.2,x:152.45,y:330.35},0).wait(203).to({scaleX:0.9315,scaleY:0.9315,x:280.45,y:19.5},0).to({x:286.45},93).wait(1).to({regX:0.4,regY:0.4,scaleX:0.4749,scaleY:0.4749,x:135.85,y:226.05},0).wait(145).to({x:135.8},0).wait(1).to({regX:-44,regY:-231.3,x:114.7,y:116},0).wait(1).to({scaleX:0.475,scaleY:0.475},0).wait(1).to({scaleX:0.4751,scaleY:0.4751,y:115.95},0).wait(1).to({scaleX:0.4752,scaleY:0.4752,y:116},0).wait(1).to({scaleX:0.4754,scaleY:0.4754},0).wait(1).to({scaleX:0.4756,scaleY:0.4756,x:114.65},0).wait(1).to({scaleX:0.4758,scaleY:0.4758,y:116.05},0).wait(1).to({scaleX:0.4762,scaleY:0.4762,x:114.7},0).wait(1).to({scaleX:0.4765,scaleY:0.4765,y:116.1},0).wait(1).to({scaleX:0.477,scaleY:0.477,x:114.65},0).wait(1).to({scaleX:0.4774,scaleY:0.4774,x:114.7},0).wait(1).to({scaleX:0.478,scaleY:0.478,x:114.65,y:116.15},0).wait(1).to({scaleX:0.4787,scaleY:0.4787,x:114.7,y:116.2},0).wait(1).to({scaleX:0.4794,scaleY:0.4794},0).wait(1).to({scaleX:0.4802,scaleY:0.4802,x:114.65,y:116.3},0).wait(1).to({scaleX:0.4811,scaleY:0.4811,x:114.7,y:116.35},0).wait(1).to({scaleX:0.4822,scaleY:0.4822,y:116.4},0).wait(1).to({scaleX:0.4833,scaleY:0.4833,y:116.45},0).wait(1).to({scaleX:0.4845,scaleY:0.4845,y:116.55},0).wait(1).to({scaleX:0.4859,scaleY:0.4859,y:116.6},0).wait(1).to({scaleX:0.4873,scaleY:0.4873,y:116.7},0).wait(1).to({scaleX:0.4888,scaleY:0.4888,y:116.8},0).wait(1).to({scaleX:0.4903,scaleY:0.4903,x:114.75,y:116.9},0).wait(1).to({scaleX:0.4918,scaleY:0.4918,x:114.7,y:116.95},0).wait(1).to({scaleX:0.4933,scaleY:0.4933,y:117.05},0).wait(1).to({scaleX:0.4948,scaleY:0.4948,x:114.75,y:117.1},0).wait(1).to({scaleX:0.4961,scaleY:0.4961,x:114.7,y:117.2},0).wait(1).to({scaleX:0.4972,scaleY:0.4972,y:117.3},0).wait(1).to({scaleX:0.4983,scaleY:0.4983,x:114.75,y:117.35},0).wait(1).to({scaleX:0.4992,scaleY:0.4992,y:117.4},0).wait(1).to({scaleX:0.4999,scaleY:0.4999},0).wait(1).to({scaleX:0.5005,scaleY:0.5005,y:117.45},0).wait(1).to({scaleX:0.501,scaleY:0.501,y:117.5},0).wait(1).to({scaleX:0.5014,scaleY:0.5014},0).wait(1).to({scaleX:0.5017,scaleY:0.5017,x:114.7,y:117.55},0).wait(1).to({scaleX:0.5019,scaleY:0.5019},0).wait(1).to({scaleX:0.502,scaleY:0.502},0).wait(1).to({regX:0.4,regY:0.3,scaleX:0.5021,scaleY:0.5021,x:137.05,y:233.9},0).wait(176).to({alpha:0.0117},13,cjs.Ease.get(1)).to({_off:true},1).wait(821));
	...
	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.2,regY:-0.1,scaleX:0.7894,scaleY:0.7894,x:-102.55,y:-72.6},0).wait(1).to({regX:165.6,regY:350,x:28.35,y:203.85},0).wait(2).to({y:203.9},0).wait(1).to({y:204},0).wait(1).to({y:204.1},0).wait(1).to({y:204.2},0).wait(1).to({y:204.35},0).wait(1).to({y:204.55},0).wait(1).to({y:204.75},0).wait(1).to({y:205.05},0).wait(1).to({y:205.35},0).wait(1).to({y:205.65},0).wait(1).to({y:206.05},0).wait(1).to({y:206.5},0).wait(1).to({y:207},0).wait(1).to({y:207.6},0).wait(1).to({y:208.2},0).wait(1).to({y:208.9},0).wait(1).to({y:209.65},0).wait(1).to({y:210.4},0).wait(1).to({y:211.2},0).wait(1).to({y:211.95},0).wait(1).to({y:212.7},0).wait(1).to({y:213.4},0).wait(1).to({y:214},0).wait(1).to({y:214.55},0).wait(1).to({y:214.95},0).wait(1).to({y:215.35},0).wait(1).to({y:215.65},0).wait(1).to({y:215.85},0).wait(1).to({y:216.05},0).wait(1).to({y:216.15},0).wait(1).to({y:216.2},0).wait(1).to({regX:-0.2,regY:-0.1,x:-102.55,y:-60.2},0).wait(203).to({scaleX:0.9315,scaleY:0.9315,x:-20.45,y:-441.3},0).to({x:-14.45},93).wait(1).to({regX:-0.3,scaleX:0.4749,scaleY:0.4749,x:-17.55,y:-8.9},0).wait(145).to({x:-17.6},0).wait(1).to({regX:165.6,regY:350,x:61.2,y:157.4},0).wait(1).to({scaleX:0.475,scaleY:0.475},0).wait(1).to({scaleX:0.4751,scaleY:0.4751},0).wait(1).to({scaleX:0.4752,scaleY:0.4752},0).wait(1).to({scaleX:0.4754,scaleY:0.4754,x:61.15,y:157.45},0).wait(1).to({scaleX:0.4756,scaleY:0.4756,y:157.5},0).wait(1).to({scaleX:0.4758,scaleY:0.4758,x:61.1,y:157.55},0).wait(1).to({scaleX:0.4762,scaleY:0.4762},0).wait(1).to({scaleX:0.4765,scaleY:0.4765,x:61.05,y:157.65},0).wait(1).to({scaleX:0.477,scaleY:0.477,x:61,y:157.7},0).wait(1).to({scaleX:0.4774,scaleY:0.4774,x:60.9,y:157.75},0).wait(1).to({scaleX:0.478,scaleY:0.478,x:60.85,y:157.85},0).wait(1).to({scaleX:0.4787,scaleY:0.4787,x:60.8,y:157.95},0).wait(1).to({scaleX:0.4794,scaleY:0.4794,x:60.75,y:158.05},0).wait(1).to({scaleX:0.4802,scaleY:0.4802,x:60.6,y:158.15},0).wait(1).to({scaleX:0.4811,scaleY:0.4811,x:60.55,y:158.3},0).wait(1).to({scaleX:0.4822,scaleY:0.4822,x:60.4,y:158.45},0).wait(1).to({scaleX:0.4833,scaleY:0.4833,x:60.3,y:158.6},0).wait(1).to({scaleX:0.4845,scaleY:0.4845,x:60.15,y:158.8},0).wait(1).to({scaleX:0.4859,scaleY:0.4859,x:60,y:159},0).wait(1).to({scaleX:0.4873,scaleY:0.4873,x:59.85,y:159.2},0).wait(1).to({scaleX:0.4888,scaleY:0.4888,x:59.7,y:159.4},0).wait(1).to({scaleX:0.4903,scaleY:0.4903,x:59.5,y:159.65},0).wait(1).to({scaleX:0.4918,scaleY:0.4918,x:59.35,y:159.85},0).wait(1).to({scaleX:0.4933,scaleY:0.4933,x:59.2,y:160.05},0).wait(1).to({scaleX:0.4948,scaleY:0.4948,x:59.05,y:160.25},0).wait(1).to({scaleX:0.4961,scaleY:0.4961,x:58.9,y:160.45},0).wait(1).to({scaleX:0.4972,scaleY:0.4972,x:58.75,y:160.65},0).wait(1).to({scaleX:0.4983,scaleY:0.4983,x:58.6,y:160.8},0).wait(1).to({scaleX:0.4992,scaleY:0.4992,x:58.5,y:160.9},0).wait(1).to({scaleX:0.4999,scaleY:0.4999,x:58.45,y:161},0).wait(1).to({scaleX:0.5005,scaleY:0.5005,x:58.4,y:161.15},0).wait(1).to({scaleX:0.501,scaleY:0.501,x:58.3,y:161.2},0).wait(1).to({scaleX:0.5014,scaleY:0.5014,y:161.25},0).wait(1).to({scaleX:0.5017,scaleY:0.5017,x:58.25,y:161.3},0).wait(1).to({scaleX:0.5019,scaleY:0.5019,x:58.2},0).wait(1).to({scaleX:0.502,scaleY:0.502,x:58.25,y:161.35},0).wait(1).to({regX:-0.2,regY:-0.1,scaleX:0.5021,scaleY:0.5021,x:-25.1,y:-14.45},0).wait(176).to({alpha:0.0117},13,cjs.Ease.get(1)).to({_off:true},1).wait(821));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(-162.3,233.9,0.5021,0.5021,0,0,0,0.4,0.3);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(491).to({_off:false},0).wait(214).to({regX:0.6,regY:0.5,scaleX:0.8256,scaleY:0.8256,x:152.75,y:345.3},0).wait(1).to({regX:-44,regY:-231.3,x:115.9,y:153.95},0).wait(1).to({y:154.05},0).wait(1).to({y:154.2},0).wait(1).to({y:154.45},0).wait(1).to({y:154.85},0).wait(1).to({y:155.35},0).wait(1).to({y:156.05},0).wait(1).to({y:156.85},0).wait(1).to({y:157.65},0).wait(1).to({y:158.25},0).wait(1).to({y:158.65},0).wait(1).to({y:158.85},0).wait(1).to({regX:0.6,regY:0.5,x:152.75,y:350.3},0).wait(215).to({regX:-44,regY:-231.3,x:115.85,y:158.9},0).wait(1).to({x:115.9},0).wait(1).to({scaleX:0.8255,scaleY:0.8255},0).wait(1).to({scaleX:0.8254,scaleY:0.8254},0).wait(1).to({scaleX:0.8252,scaleY:0.8252},0).wait(1).to({scaleX:0.825,scaleY:0.825,y:158.95},0).wait(1).to({scaleX:0.8247,scaleY:0.8247,x:115.85,y:158.9},0).wait(1).to({scaleX:0.8244,scaleY:0.8244},0).wait(1).to({scaleX:0.8241,scaleY:0.8241,x:115.9},0).wait(1).to({scaleX:0.8236,scaleY:0.8236,x:115.85},0).wait(1).to({scaleX:0.8231,scaleY:0.8231},0).wait(1).to({scaleX:0.8225,scaleY:0.8225},0).wait(1).to({scaleX:0.8219,scaleY:0.8219},0).wait(1).to({scaleX:0.8211,scaleY:0.8211,x:115.8},0).wait(1).to({scaleX:0.8202,scaleY:0.8202},0).wait(1).to({scaleX:0.8193,scaleY:0.8193,y:158.85},0).wait(1).to({scaleX:0.8182,scaleY:0.8182},0).wait(1).to({scaleX:0.8171,scaleY:0.8171,x:115.75},0).wait(1).to({scaleX:0.816,scaleY:0.816,y:158.8},0).wait(1).to({scaleX:0.8148,scaleY:0.8148,x:115.7,y:158.85},0).wait(1).to({scaleX:0.8138,scaleY:0.8138},0).wait(1).to({scaleX:0.8128,scaleY:0.8128,y:158.8},0).wait(1).to({scaleX:0.8119,scaleY:0.8119},0).wait(1).to({scaleX:0.8112,scaleY:0.8112,x:115.65},0).wait(1).to({scaleX:0.8105,scaleY:0.8105,y:158.75},0).wait(1).to({scaleX:0.8101,scaleY:0.8101,y:158.8},0).wait(1).to({scaleX:0.8097,scaleY:0.8097,x:115.6,y:158.75},0).wait(1).to({scaleX:0.8094,scaleY:0.8094,x:115.65,y:158.8},0).wait(1).to({scaleX:0.8092,scaleY:0.8092},0).wait(1).to({scaleX:0.8091,scaleY:0.8091},0).wait(1).to({regX:0.6,regY:0.5,x:151.75,y:346.35},0).wait(171).to({regX:-44,regY:-231.3,x:115.65,y:158.8},0).wait(1).to({scaleX:0.8092,scaleY:0.8092,y:158.75},0).wait(1).to({scaleX:0.8094,scaleY:0.8094,y:158.8},0).wait(1).to({scaleX:0.8097,scaleY:0.8097,x:115.6},0).wait(1).to({scaleX:0.8101,scaleY:0.8101,x:115.65},0).wait(1).to({scaleX:0.8106,scaleY:0.8106,y:158.85},0).wait(1).to({scaleX:0.8112,scaleY:0.8112,y:158.9},0).wait(1).to({scaleX:0.8119,scaleY:0.8119,x:115.7},0).wait(1).to({scaleX:0.8127,scaleY:0.8127,x:115.65},0).wait(1).to({scaleX:0.8137,scaleY:0.8137,x:115.7,y:159},0).wait(1).to({scaleX:0.8148,scaleY:0.8148,y:159.05},0).wait(1).to({scaleX:0.8161,scaleY:0.8161,y:159.1},0).wait(1).to({scaleX:0.8176,scaleY:0.8176,x:115.75,y:159.15},0).wait(1).to({scaleX:0.8193,scaleY:0.8193,y:159.2},0).wait(1).to({scaleX:0.8212,scaleY:0.8212,y:159.3},0).wait(1).to({scaleX:0.8233,scaleY:0.8233,x:115.8,y:159.4},0).wait(1).to({scaleX:0.8256,scaleY:0.8256,x:115.75,y:159.5},0).wait(1).to({scaleX:0.8282,scaleY:0.8282,x:115.8,y:159.6},0).wait(1).to({scaleX:0.831,scaleY:0.831,x:115.85,y:159.75},0).wait(1).to({scaleX:0.834,scaleY:0.834,x:115.9,y:159.85},0).wait(1).to({scaleX:0.8372,scaleY:0.8372,y:160},0).wait(1).to({scaleX:0.8405,scaleY:0.8405,x:115.95,y:160.15},0).wait(1).to({scaleX:0.8439,scaleY:0.8439,y:160.25},0).wait(1).to({scaleX:0.8472,scaleY:0.8472,x:116,y:160.45},0).wait(1).to({scaleX:0.8504,scaleY:0.8504,x:116.05,y:160.55},0).wait(1).to({scaleX:0.8533,scaleY:0.8533,x:116.1,y:160.65},0).wait(1).to({scaleX:0.856,scaleY:0.856,x:116.15,y:160.8},0).wait(1).to({scaleX:0.8583,scaleY:0.8583,y:160.9},0).wait(1).to({scaleX:0.8604,scaleY:0.8604,y:161},0).wait(1).to({scaleX:0.8621,scaleY:0.8621,y:161.05},0).wait(1).to({scaleX:0.8635,scaleY:0.8635,x:116.2,y:161.15},0).wait(1).to({scaleX:0.8646,scaleY:0.8646},0).wait(1).to({scaleX:0.8655,scaleY:0.8655,y:161.2},0).wait(1).to({scaleX:0.8661,scaleY:0.8661,x:116.25},0).wait(1).to({scaleX:0.8666,scaleY:0.8666,x:116.2,y:161.25},0).wait(1).to({scaleX:0.8668,scaleY:0.8668},0).wait(1).to({regX:0.6,regY:0.5,scaleX:0.8669,scaleY:0.8669,x:154.85,y:362.25},0).wait(161).to({regX:0.7,regY:0.8,scaleX:0.4785,scaleY:0.4785,x:133,y:233.35},0).to({_off:true},129).wait(80));

	// bg
	this.bg1_1 = new lib.bg_zoom_half();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-324.45,-14.45,0.5021,0.5021,0,0,0,-0.2,-0.1);
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(491).to({_off:false},0).wait(214).to({regX:-0.3,regY:-0.2,scaleX:0.8256,scaleY:0.8256,x:-114,y:-63.1},0).wait(1).to({regX:165.6,regY:350,x:22.95,y:226.05},0).wait(1).to({y:226.15},0).wait(1).to({y:226.3},0).wait(1).to({y:226.55},0).wait(1).to({y:226.95},0).wait(1).to({y:227.45},0).wait(1).to({y:228.15},0).wait(1).to({y:228.95},0).wait(1).to({y:229.75},0).wait(1).to({y:230.35},0).wait(1).to({y:230.75},0).wait(1).to({y:230.95},0).wait(1).to({regX:-0.3,regY:-0.2,x:-114,y:-58.1},0).wait(215).to({regX:165.6,regY:350,x:23,y:231.05},0).wait(2).to({scaleX:0.8255,scaleY:0.8255,y:231},0).wait(1).to({scaleX:0.8254,scaleY:0.8254,x:23.05},0).wait(1).to({scaleX:0.8252,scaleY:0.8252},0).wait(1).to({scaleX:0.825,scaleY:0.825},0).wait(1).to({scaleX:0.8247,scaleY:0.8247,x:23.1,y:230.95},0).wait(1).to({scaleX:0.8244,scaleY:0.8244,x:23.15},0).wait(1).to({scaleX:0.8241,scaleY:0.8241,y:230.85},0).wait(1).to({scaleX:0.8236,scaleY:0.8236,x:23.2},0).wait(1).to({scaleX:0.8231,scaleY:0.8231,x:23.25,y:230.8},0).wait(1).to({scaleX:0.8225,scaleY:0.8225,x:23.3,y:230.75},0).wait(1).to({scaleX:0.8219,scaleY:0.8219,x:23.35,y:230.7},0).wait(1).to({scaleX:0.8211,scaleY:0.8211,x:23.4,y:230.65},0).wait(1).to({scaleX:0.8202,scaleY:0.8202,x:23.55,y:230.55},0).wait(1).to({scaleX:0.8193,scaleY:0.8193,x:23.6,y:230.45},0).wait(1).to({scaleX:0.8182,scaleY:0.8182,x:23.7,y:230.35},0).wait(1).to({scaleX:0.8171,scaleY:0.8171,x:23.8,y:230.25},0).wait(1).to({scaleX:0.816,scaleY:0.816,x:23.9,y:230.15},0).wait(1).to({scaleX:0.8148,scaleY:0.8148,x:24.05,y:230},0).wait(1).to({scaleX:0.8138,scaleY:0.8138,x:24.15,y:229.9},0).wait(1).to({scaleX:0.8128,scaleY:0.8128,x:24.25,y:229.8},0).wait(1).to({scaleX:0.8119,scaleY:0.8119,x:24.35,y:229.7},0).wait(1).to({scaleX:0.8112,scaleY:0.8112,x:24.45,y:229.65},0).wait(1).to({scaleX:0.8105,scaleY:0.8105,x:24.5,y:229.6},0).wait(1).to({scaleX:0.8101,scaleY:0.8101,y:229.55},0).wait(1).to({scaleX:0.8097,scaleY:0.8097,x:24.55},0).wait(1).to({scaleX:0.8094,scaleY:0.8094,x:24.6,y:229.5},0).wait(1).to({scaleX:0.8092,scaleY:0.8092},0).wait(1).to({scaleX:0.8091,scaleY:0.8091},0).wait(1).to({regX:-0.3,regY:-0.3,x:-109.65,y:-53.95},0).wait(171).to({regX:165.6,regY:350,x:24.6,y:229.5},0).wait(1).to({scaleX:0.8092,scaleY:0.8092,y:229.55},0).wait(1).to({scaleX:0.8094,scaleY:0.8094},0).wait(1).to({scaleX:0.8097,scaleY:0.8097,x:24.55,y:229.6},0).wait(1).to({scaleX:0.8101,scaleY:0.8101,x:24.5,y:229.65},0).wait(1).to({scaleX:0.8106,scaleY:0.8106,x:24.45,y:229.7},0).wait(1).to({scaleX:0.8112,scaleY:0.8112,x:24.4,y:229.75},0).wait(1).to({scaleX:0.8119,scaleY:0.8119,x:24.3,y:229.85},0).wait(1).to({scaleX:0.8127,scaleY:0.8127,x:24.25,y:230},0).wait(1).to({scaleX:0.8137,scaleY:0.8137,x:24.15,y:230.1},0).wait(1).to({scaleX:0.8148,scaleY:0.8148,x:24.05,y:230.25},0).wait(1).to({scaleX:0.8161,scaleY:0.8161,x:23.9,y:230.45},0).wait(1).to({scaleX:0.8176,scaleY:0.8176,x:23.75,y:230.6},0).wait(1).to({scaleX:0.8193,scaleY:0.8193,x:23.55,y:230.85},0).wait(1).to({scaleX:0.8212,scaleY:0.8212,x:23.4,y:231.1},0).wait(1).to({scaleX:0.8233,scaleY:0.8233,x:23.15,y:231.35},0).wait(1).to({scaleX:0.8256,scaleY:0.8256,x:22.9,y:231.65},0).wait(1).to({scaleX:0.8282,scaleY:0.8282,x:22.65,y:232},0).wait(1).to({scaleX:0.831,scaleY:0.831,x:22.35,y:232.4},0).wait(1).to({scaleX:0.834,scaleY:0.834,x:22,y:232.75},0).wait(1).to({scaleX:0.8372,scaleY:0.8372,x:21.7,y:233.15},0).wait(1).to({scaleX:0.8405,scaleY:0.8405,x:21.35,y:233.65},0).wait(1).to({scaleX:0.8439,scaleY:0.8439,x:21,y:234.05},0).wait(1).to({scaleX:0.8472,scaleY:0.8472,x:20.65,y:234.5},0).wait(1).to({scaleX:0.8504,scaleY:0.8504,x:20.3,y:234.95},0).wait(1).to({scaleX:0.8533,scaleY:0.8533,x:20.05,y:235.3},0).wait(1).to({scaleX:0.856,scaleY:0.856,x:19.75,y:235.65},0).wait(1).to({scaleX:0.8583,scaleY:0.8583,x:19.55,y:235.95},0).wait(1).to({scaleX:0.8604,scaleY:0.8604,x:19.3,y:236.2},0).wait(1).to({scaleX:0.8621,scaleY:0.8621,x:19.15,y:236.45},0).wait(1).to({scaleX:0.8635,scaleY:0.8635,x:19,y:236.6},0).wait(1).to({scaleX:0.8646,scaleY:0.8646,x:18.9,y:236.75},0).wait(1).to({scaleX:0.8655,scaleY:0.8655,x:18.75,y:236.9},0).wait(1).to({scaleX:0.8661,scaleY:0.8661,y:237},0).wait(1).to({scaleX:0.8666,scaleY:0.8666,x:18.65,y:237.05},0).wait(1).to({scaleX:0.8668,scaleY:0.8668,y:237.1},0).wait(1).to({regX:-0.3,regY:-0.3,scaleX:0.8669,scaleY:0.8669,x:-125.15,y:-66.6},0).wait(161).to({regX:-0.4,scaleX:0.4785,scaleY:0.4785,x:-21.6,y:-3.45},0).to({_off:true},129).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1448).wait(92));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1460).wait(75).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-312.7,-720,1009.3,1393);
// library properties:
lib.properties = {
	id: '_434_3',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1611559239992", id:"_434_3_bg"},
		{src:"images/ch_base.png?1611559239992", id:"_434_3_ch_base"},
		{src:"images/ch_face10.png?1611559239992", id:"_434_3_ch_face10"},
		{src:"images/ch_face2.png?1611559239992", id:"_434_3_ch_face2"},
		{src:"images/ch_face3.png?1611559239992", id:"_434_3_ch_face3"},
		{src:"images/ch_face5.png?1611559239992", id:"_434_3_ch_face5"},
		{src:"images/ch_face6.png?1611559239992", id:"_434_3_ch_face6"},
		{src:"images/ch_face7.png?1611559239992", id:"_434_3_ch_face7"},
		{src:"images/ch_face8.png?1611559239992", id:"_434_3_ch_face8"},
		{src:"images/ch_face9.png?1611559239992", id:"_434_3_ch_face9"},
		{src:"images/finish.jpg?1611559239992", id:"_434_3_finish"},
		{src:"images/finish_blur.jpg?1611559239992", id:"_434_3_finish_blur"},
		{src:"images/tie_fp.png?1611559239992", id:"_434_3_tie_fp"},
		{src:"images/tie_sp.png?1611559239992", id:"_434_3_tie_sp"}
	],
	preloads: []
};
